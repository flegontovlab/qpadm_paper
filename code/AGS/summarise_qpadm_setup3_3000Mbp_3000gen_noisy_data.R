...
outs = "./projects/qpadm/results/qpadm/30chr_deep_subsampled/"

outf = paste0(outs, sim)

for (replc in 1:10){
  out1 = readRDS(paste0(outf, '/qpadm_sim_1_sub', replc, "_1way_rotating.rds"))
  out2 = readRDS(paste0(outf, '/qpadm_sim_1_sub', replc, "_2way_rotating.rds"))
  ...
  write.csv(outtab, file=paste0(outf, "/qpadm_subsampled_summary_rotating_", sim, "_", replc, ".csv"), row.names=FALSE)
}
