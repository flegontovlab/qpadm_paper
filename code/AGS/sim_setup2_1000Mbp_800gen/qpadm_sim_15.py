...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("J", "C", "M", "F", "K", "G", "I", "L", "A", "B", "D", "H", "E"), (151, 151, 521, 345, 345, 243, 0, 74, 0, 311, 367, 311, 28) )]
...
demo.add_population_split(time=74, ancestral="admixd", derived=["E"])
demo.add_population_split(time=28, ancestral="admixe", derived=["A"])
demo.add_population_split(time=311, ancestral="admixl", derived=["Rrl"])
demo.add_population_split(time=28, ancestral="admixq", derived=["I"])
demo.add_population_split(time=345, ancestral="admixqc", derived=["B"])
demo.add_population_split(time=367, ancestral="admixy", derived=["Rlr"])
demo.add_population_split(time=651, ancestral="R", derived=["Rr","Rn"])
demo.add_population_split(time=543, ancestral="Rl", derived=["Rll","Rlb"])
demo.add_population_split(time=521, ancestral="Rll", derived=["Rllry","Rllz"])
demo.add_population_split(time=367, ancestral="Rllr", derived=["Rllrs"])
demo.add_population_split(time=345, ancestral="Rllrs", derived=["H"])
demo.add_population_split(time=410, ancestral="Rllry", derived=["Rlld"])
demo.add_population_split(time=410, ancestral="Rllz", derived=["Rllr"])
demo.add_population_split(time=609, ancestral="Rn", derived=["Rl"])
demo.add_population_split(time=609, ancestral="Rr", derived=["Rrr"])
demo.add_population_split(time=243, ancestral="Rrl", derived=["Rrll","Rrlr"])
demo.add_population_split(time=190, ancestral="Rrll", derived=["J","Rrllx"])
demo.add_population_split(time=190, ancestral="Rrlr", derived=["C","Rrlro"])
demo.add_population_split(time=151, ancestral="Rrlro", derived=["L"])
demo.add_population_split(time=543, ancestral="Rrr", derived=["M","Rrrr"])
demo.add_population_split(time=521, ancestral="Rrrr", derived=["Rrrrrn","Rrrru"])
demo.add_population_split(time=367, ancestral="Rrrrr", derived=["F","K"])
demo.add_population_split(time=410, ancestral="Rrrrrn", derived=["Rrrrr"])
demo.add_population_split(time=410, ancestral="Rrrru", derived=["D"])
demo.add_admixture(time=311, derived="admix", ancestral=["Rlr","Rlld"], proportions=[0.51,0.49])
demo.add_admixture(time=74, derived="admixd", ancestral=["Rrllx","Rn"], proportions=[0.65,0.35])
demo.add_admixture(time=28, derived="admixe", ancestral=["Rrlro","Rlr"], proportions=[0.74,0.26])
demo.add_admixture(time=367, derived="admixf", ancestral=["admixx","Rllry"], proportions=[0.3,0.7])
demo.add_admixture(time=311, derived="admixl", ancestral=["Rllrs","admixf"], proportions=[0.69,0.31])
demo.add_admixture(time=28, derived="admixq", ancestral=["admixr","Rllr"], proportions=[0.47,0.53])
demo.add_admixture(time=345, derived="admixqc", ancestral=["Rlld","Rrrrrn"], proportions=[0.36,0.64])
demo.add_admixture(time=74, derived="admixr", ancestral=["Rrllx","Rllz"], proportions=[0.55,0.45])
demo.add_admixture(time=410, derived="admixx", ancestral=["Rlb","Rr"], proportions=[0.45,0.55])
demo.add_admixture(time=367, derived="admixy", ancestral=["Rrrru","Rlb"], proportions=[0.67,0.33])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_15/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_15/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_15/qpadm_sim_' + sim_id + '.ind', 'w') as f:
