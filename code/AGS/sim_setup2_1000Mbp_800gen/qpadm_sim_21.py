...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("C", "A", "K", "M", "G", "J", "D", "L", "E", "I", "B", "F", "H"), (162, 535, 221, 363, 162, 162, 92, 51, 162, 92, 162, 26, 0) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_21/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_21/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_21/qpadm_sim_' + sim_id + '.ind', 'w') as f:
