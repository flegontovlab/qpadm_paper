...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("K", "C", "H", "J", "A", "I", "F", "E", "B", "M", "D", "L", "G"), (160, 160, 271, 360, 360, 460, 160, 193, 228, 228, 53, 0, 271) )]
...
demo.add_population_split(time=228, ancestral="admix", derived=["Rllr"])
demo.add_population_split(time=360, ancestral="admixg", derived=["Rlls"])
demo.add_population_split(time=53, ancestral="admixm", derived=["L"])
demo.add_population_split(time=360, ancestral="admixn", derived=["Rlrlf"])
demo.add_population_split(time=160, ancestral="admixo", derived=["D"])
demo.add_population_split(time=271, ancestral="admixod", derived=["Rrr"])
demo.add_population_split(time=648, ancestral="R", derived=["Rl","Ru"])
demo.add_population_split(time=550, ancestral="Rl", derived=["Rlr","Rlk"])
demo.add_population_split(time=460, ancestral="Rlh", derived=["Rll","Rlhc"])
demo.add_population_split(time=490, ancestral="Rlk", derived=["Rlh"])
demo.add_population_split(time=193, ancestral="Rllr", derived=["K","C"])
demo.add_population_split(time=271, ancestral="Rlls", derived=["M"])
demo.add_population_split(time=490, ancestral="Rlr", derived=["Rlrr","Rlrt"])
demo.add_population_split(time=438, ancestral="Rlrl", derived=["Rlrll"])
demo.add_population_split(time=271, ancestral="Rlrlf", derived=["B"])
demo.add_population_split(time=360, ancestral="Rlrll", derived=["H"])
demo.add_population_split(time=460, ancestral="Rlrr", derived=["Rlrrl","Rlrrj"])
demo.add_population_split(time=438, ancestral="Rlrrj", derived=["Rlrrju"])
demo.add_population_split(time=360, ancestral="Rlrrju", derived=["G"])
demo.add_population_split(time=438, ancestral="Rlrrl", derived=["J","A"])
demo.add_population_split(time=460, ancestral="Rlrt", derived=["Rlrl"])
demo.add_population_split(time=490, ancestral="Rr", derived=["I","Rra"])
demo.add_population_split(time=228, ancestral="Rrr", derived=["Rrrl","E"])
demo.add_population_split(time=193, ancestral="Rrrl", derived=["F"])
demo.add_population_split(time=550, ancestral="Ru", derived=["Rr"])
demo.add_admixture(time=228, derived="admix", ancestral=["Rlrlf","Rll"], proportions=[0.86,0.14])
demo.add_admixture(time=438, derived="admixb", ancestral=["Rra","Ru"], proportions=[0.39,0.61])
demo.add_admixture(time=360, derived="admixg", ancestral=["Rll","Rra"], proportions=[0.26,0.74])
demo.add_admixture(time=160, derived="admixl", ancestral=["admixla","Rlls"], proportions=[0.46,0.54])
demo.add_admixture(time=228, derived="admixla", ancestral=["admixw","Rlhc"], proportions=[0.19,0.81])
demo.add_admixture(time=53, derived="admixm", ancestral=["admixl","Rlrrj"], proportions=[0.31,0.69])
demo.add_admixture(time=360, derived="admixn", ancestral=["Rlrl","Rlk"], proportions=[0.63,0.37])
demo.add_admixture(time=160, derived="admixo", ancestral=["Rrrl","Rlhc"], proportions=[0.5,0.5])
demo.add_admixture(time=271, derived="admixod", ancestral=["admixb","Rlrt"], proportions=[0.13,0.87])
demo.add_admixture(time=271, derived="admixw", ancestral=["Rlrll","Rlrrju"], proportions=[0.18,0.82])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_11/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_11/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_11/qpadm_sim_' + sim_id + '.ind', 'w') as f:
