...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("K", "E", "G", "F", "B", "J", "D", "L", "A", "M", "I", "C", "H"), (430, 319, 521, 213, 79, 59, 192, 319, 59, 213, 0, 59, 22) )]
...
demo.add_population_split(time=22, ancestral="admixa", derived=["I"])
demo.add_population_split(time=288, ancestral="admixd", derived=["M"])
demo.add_population_split(time=59, ancestral="admixg", derived=["H"])
demo.add_population_split(time=391, ancestral="admixi", derived=["Rrr"])
demo.add_population_split(time=192, ancestral="admixo", derived=["Rrrrr"])
demo.add_population_split(time=79, ancestral="admixq", derived=["A"])
demo.add_population_split(time=391, ancestral="admixx", derived=["L"])
demo.add_population_split(time=780, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=715, ancestral="Rl", derived=["Rllw","Rlg"])
demo.add_population_split(time=521, ancestral="Rll", derived=["K","Rllh"])
demo.add_population_split(time=430, ancestral="Rllh", derived=["Rllr"])
demo.add_population_split(time=391, ancestral="Rllr", derived=["E"])
demo.add_population_split(time=625, ancestral="Rllw", derived=["Rll"])
demo.add_population_split(time=715, ancestral="Rr", derived=["Rrl"])
demo.add_population_split(time=625, ancestral="Rrl", derived=["G","Rrls"])
demo.add_population_split(time=430, ancestral="Rrlg", derived=["Rrlgw"])
demo.add_population_split(time=391, ancestral="Rrlgw", derived=["Rrlgwd"])
demo.add_population_split(time=521, ancestral="Rrls", derived=["Rrlg"])
demo.add_population_split(time=319, ancestral="Rrr", derived=["Rrrl","Rrrr"])
demo.add_population_split(time=288, ancestral="Rrrl", derived=["F","Rrrlf"])
demo.add_population_split(time=213, ancestral="Rrrlf", derived=["D"])
demo.add_population_split(time=288, ancestral="Rrrr", derived=["Rrrrl"])
demo.add_population_split(time=213, ancestral="Rrrrl", derived=["Rrrrll","Rrrrld"])
demo.add_population_split(time=192, ancestral="Rrrrll", derived=["B","Rrrrlll"])
demo.add_population_split(time=79, ancestral="Rrrrlll", derived=["C"])
demo.add_population_split(time=79, ancestral="Rrrrr", derived=["J"])
demo.add_admixture(time=79, derived="admix", ancestral=["Rrrlf","Rrlgwd"], proportions=[0.8,0.2])
demo.add_admixture(time=22, derived="admixa", ancestral=["admixu","Rrrrld"], proportions=[0.48,0.52])
demo.add_admixture(time=288, derived="admixd", ancestral=["Rrlgwd","Rllr"], proportions=[0.75,0.25])
demo.add_admixture(time=59, derived="admixg", ancestral=["admix","Rrls"], proportions=[0.27,0.73])
demo.add_admixture(time=391, derived="admixi", ancestral=["Rllh","Rr"], proportions=[0.46,0.54])
demo.add_admixture(time=192, derived="admixo", ancestral=["admixxs","Rllw"], proportions=[0.37,0.63])
demo.add_admixture(time=79, derived="admixq", ancestral=["Rrrrld","Rlg"], proportions=[0.88,0.12])
demo.add_admixture(time=59, derived="admixu", ancestral=["Rrrrr","Rrrrlll"], proportions=[0.7,0.3])
demo.add_admixture(time=391, derived="admixx", ancestral=["Rrlg","Rlg"], proportions=[0.68,0.32])
demo.add_admixture(time=213, derived="admixxs", ancestral=["Rrrr","Rrlgw"], proportions=[0.76,0.24])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_19/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_19/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_19/qpadm_sim_' + sim_id + '.ind', 'w') as f:
