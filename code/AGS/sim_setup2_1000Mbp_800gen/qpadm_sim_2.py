...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("I", "B", "M", "K", "A", "F", "H", "J", "L", "E", "C", "D", "G"), (482, 130, 0, 0, 28, 28, 130, 28, 0, 325, 130, 0, 130) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_2/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_2/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_2/qpadm_sim_' + sim_id + '.ind', 'w') as f:
