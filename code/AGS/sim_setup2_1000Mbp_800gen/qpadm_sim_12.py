...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("B", "M", "F", "D", "J", "L", "E", "C", "G", "I", "H", "A", "K"), (671, 305, 366, 390, 462, 366, 305, 100, 671, 366, 366, 0, 366) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_12/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_12/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_12/qpadm_sim_' + sim_id + '.ind', 'w') as f:
