...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("G", "C", "I", "F", "M", "B", "D", "K", "E", "J", "L", "H", "A"), (471, 216, 542, 216, 341, 104, 648, 216, 542, 296, 216, 73, 0) )]
...
demo.add_population_split(time=216, ancestral="admix", derived=["B"])
demo.add_population_split(time=648, ancestral="admixa", derived=["Rlr"])
demo.add_population_split(time=437, ancestral="admixc", derived=["Rllrlo"])
demo.add_population_split(time=296, ancestral="admixh", derived=["L"])
demo.add_population_split(time=216, ancestral="admixi", derived=["admixio"])
demo.add_population_split(time=104, ancestral="admixio", derived=["H"])
demo.add_population_split(time=73, ancestral="admixs", derived=["A"])
demo.add_population_split(time=341, ancestral="admixu", derived=["Rlrrlr"])
demo.add_population_split(time=296, ancestral="admixx", derived=["K"])
demo.add_population_split(time=709, ancestral="R", derived=["Rl","Ro"])
demo.add_population_split(time=669, ancestral="Rl", derived=["Rll"])
demo.add_population_split(time=648, ancestral="Rll", derived=["Rllr","Rlls"])
demo.add_population_split(time=623, ancestral="Rllr", derived=["Rllrl","I"])
demo.add_population_split(time=542, ancestral="Rllrl", derived=["G"])
demo.add_population_split(time=341, ancestral="Rllrlo", derived=["Rllrlr"])
demo.add_population_split(time=296, ancestral="Rllrlr", derived=["C"])
demo.add_population_split(time=623, ancestral="Rlls", derived=["E"])
demo.add_population_split(time=623, ancestral="Rlr", derived=["Rlrl","Rlrc"])
demo.add_population_split(time=542, ancestral="Rlrc", derived=["Rlrr"])
demo.add_population_split(time=542, ancestral="Rlrl", derived=["Rlrlv","Rlrlh"])
demo.add_population_split(time=471, ancestral="Rlrlv", derived=["Rlrlva"])
demo.add_population_split(time=471, ancestral="Rlrr", derived=["Rlrrl","Rlrrr"])
demo.add_population_split(time=437, ancestral="Rlrrl", derived=["Rlrrlh"])
demo.add_population_split(time=296, ancestral="Rlrrlr", derived=["F"])
demo.add_population_split(time=437, ancestral="Rlrrr", derived=["M","Rlrrry"])
demo.add_population_split(time=341, ancestral="Rlrrry", derived=["J"])
demo.add_population_split(time=669, ancestral="Ro", derived=["D"])
demo.add_admixture(time=216, derived="admix", ancestral=["Rllrlo","admixcd"], proportions=[0.72,0.28])
demo.add_admixture(time=648, derived="admixa", ancestral=["Rl","Ro"], proportions=[0.29,0.71])
demo.add_admixture(time=471, derived="admixb", ancestral=["Rlrc","Rlls"], proportions=[0.61,0.39])
demo.add_admixture(time=437, derived="admixc", ancestral=["admixb","Rllrl"], proportions=[0.26,0.74])
demo.add_admixture(time=341, derived="admixcd", ancestral=["Rlrlva","Rlrlh"], proportions=[0.59,0.41])
demo.add_admixture(time=296, derived="admixh", ancestral=["Rlrrry","Rlrlv"], proportions=[0.68,0.32])
demo.add_admixture(time=216, derived="admixi", ancestral=["Rllrlr","Rlrrlh"], proportions=[0.14,0.86])
demo.add_admixture(time=73, derived="admixs", ancestral=["admixio","Rlrrlr"], proportions=[0.39,0.61])
demo.add_admixture(time=341, derived="admixu", ancestral=["Rlrrl","Rlrlva"], proportions=[0.84,0.16])
demo.add_admixture(time=296, derived="admixx", ancestral=["Rlrrlh","Rlrlh"], proportions=[0.76,0.24])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_3/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_3/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_3/qpadm_sim_' + sim_id + '.ind', 'w') as f:
