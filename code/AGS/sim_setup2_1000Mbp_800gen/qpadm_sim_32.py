...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("M", "J", "H", "E", "K", "I", "F", "B", "D", "C", "A", "G", "L"), (457, 362, 602, 362, 280, 280, 0, 0, 181, 181, 92, 181, 92) )]
...
demo.add_population_split(time=362, ancestral="admix", derived=["admixex"])
demo.add_population_split(time=241, ancestral="admixc", derived=["admixce"])
demo.add_population_split(time=181, ancestral="admixce", derived=["L"])
demo.add_population_split(time=241, ancestral="admixe", derived=["D"])
demo.add_population_split(time=241, ancestral="admixj", derived=["G"])
demo.add_population_split(time=241, ancestral="admixt", derived=["C"])
demo.add_population_split(time=92, ancestral="admixw", derived=["Rrrr"])
demo.add_population_split(time=602, ancestral="admixxw", derived=["Rll"])
demo.add_population_split(time=181, ancestral="admixyp", derived=["A"])
demo.add_population_split(time=708, ancestral="R", derived=["Rl","Rn"])
demo.add_population_split(time=662, ancestral="Rl", derived=["H"])
demo.add_population_split(time=555, ancestral="Rll", derived=["M","Rllo"])
demo.add_population_split(time=457, ancestral="Rllo", derived=["Rllr","Rlloc"])
demo.add_population_split(time=431, ancestral="Rllr", derived=["J","Rllrx"])
demo.add_population_split(time=662, ancestral="Rn", derived=["Rr"])
demo.add_population_split(time=602, ancestral="Rr", derived=["Rrl","Rrt"])
demo.add_population_split(time=555, ancestral="Rrl", derived=["Rrll"])
demo.add_population_split(time=457, ancestral="Rrll", derived=["Rrllr"])
demo.add_population_split(time=431, ancestral="Rrllr", derived=["E"])
demo.add_population_split(time=457, ancestral="Rrr", derived=["Rrrl","Rrru"])
demo.add_population_split(time=431, ancestral="Rrrl", derived=["Rrrll","Rrrly"])
demo.add_population_split(time=362, ancestral="Rrrll", derived=["K","I"])
demo.add_population_split(time=362, ancestral="Rrrly", derived=["Rrrlye"])
demo.add_population_split(time=20, ancestral="Rrrr", derived=["F","B"])
demo.add_population_split(time=555, ancestral="Rrt", derived=["Rrr"])
demo.add_admixture(time=362, derived="admix", ancestral=["Rlloc","Rrl"], proportions=[0.44,0.56])
demo.add_admixture(time=241, derived="admixc", ancestral=["admixex","Rllrx"], proportions=[0.39,0.61])
demo.add_admixture(time=241, derived="admixe", ancestral=["admixx","Rrllr"], proportions=[0.37,0.63])
demo.add_admixture(time=241, derived="admixj", ancestral=["Rrrlye","Rrru"], proportions=[0.29,0.71])
demo.add_admixture(time=241, derived="admixt", ancestral=["admixex","Rrt"], proportions=[0.22,0.78])
demo.add_admixture(time=92, derived="admixw", ancestral=["admixce","Rrru"], proportions=[0.5,0.5])
demo.add_admixture(time=280, derived="admixx", ancestral=["Rrrly","Rlloc"], proportions=[0.74,0.26])
demo.add_admixture(time=602, derived="admixxw", ancestral=["Rl","Rn"], proportions=[0.48,0.52])
demo.add_admixture(time=241, derived="admixy", ancestral=["Rrrlye","Rrll"], proportions=[0.56,0.44])
demo.add_admixture(time=181, derived="admixyp", ancestral=["admixy","Rllrx"], proportions=[0.2,0.8])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_32/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_32/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_32/qpadm_sim_' + sim_id + '.ind', 'w') as f:
