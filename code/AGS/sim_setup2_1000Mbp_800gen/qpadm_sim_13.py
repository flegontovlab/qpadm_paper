...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("L", "I", "A", "E", "J", "C", "M", "H", "G", "B", "K", "F", "D"), (353, 454, 139, 139, 212, 139, 65, 212, 0, 139, 139, 139, 65) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_13/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_13/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_13/qpadm_sim_' + sim_id + '.ind', 'w') as f:
