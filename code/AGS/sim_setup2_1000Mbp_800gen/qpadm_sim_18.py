...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("D", "H", "G", "F", "M", "E", "L", "B", "A", "I", "J", "K", "C"), (135, 135, 557, 265, 207, 557, 557, 557, 42, 0, 455, 135, 42) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_18/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_18/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_18/qpadm_sim_' + sim_id + '.ind', 'w') as f:
