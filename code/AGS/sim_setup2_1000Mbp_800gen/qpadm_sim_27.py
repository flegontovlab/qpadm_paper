...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("C", "K", "E", "D", "F", "I", "M", "J", "B", "L", "H", "G", "A"), (373, 416, 327, 350, 350, 350, 0, 210, 350, 239, 210, 210, 140) )]
...
demo.add_population_split(time=32, ancestral="admix", derived=["M"])
demo.add_population_split(time=210, ancestral="admixm", derived=["A"])
demo.add_population_split(time=239, ancestral="admixn", derived=["J"])
demo.add_population_split(time=239, ancestral="admixou", derived=["H"])
demo.add_population_split(time=327, ancestral="admixr", derived=["admixrx"])
demo.add_population_split(time=239, ancestral="admixrx", derived=["G"])
demo.add_population_split(time=327, ancestral="admixy", derived=["L"])
demo.add_population_split(time=698, ancestral="R", derived=["Rl","Rx"])
demo.add_population_split(time=616, ancestral="Rl", derived=["Rll","Rlr"])
demo.add_population_split(time=527, ancestral="Rll", derived=["Rlll","Rllr"])
demo.add_population_split(time=416, ancestral="Rlll", derived=["C","Rlllk"])
demo.add_population_split(time=373, ancestral="Rlllk", derived=["B"])
demo.add_population_split(time=416, ancestral="Rllr", derived=["Rllrx"])
demo.add_population_split(time=373, ancestral="Rllrx", derived=["I"])
demo.add_population_split(time=527, ancestral="Rlr", derived=["K","Rlrb"])
demo.add_population_split(time=527, ancestral="Rr", derived=["Rrr","Rrf"])
demo.add_population_split(time=416, ancestral="Rrf", derived=["Rrl","Rrfm"])
demo.add_population_split(time=373, ancestral="Rrfm", derived=["Rrfmv"])
demo.add_population_split(time=350, ancestral="Rrfmv", derived=["Rrfmvp"])
demo.add_population_split(time=373, ancestral="Rrl", derived=["Rrlr","Rrlt"])
demo.add_population_split(time=350, ancestral="Rrlr", derived=["E"])
demo.add_population_split(time=416, ancestral="Rrr", derived=["Rrrl","Rrrr"])
demo.add_population_split(time=373, ancestral="Rrrl", derived=["D","F"])
demo.add_population_split(time=616, ancestral="Rx", derived=["Rr"])
demo.add_admixture(time=32, derived="admix", ancestral=["admixo","Rlrb"], proportions=[0.19,0.81])
demo.add_admixture(time=327, derived="admixd", ancestral=["Rrfmv","Rlrb"], proportions=[0.88,0.12])
demo.add_admixture(time=210, derived="admixm", ancestral=["admixrx","Rrrr"], proportions=[0.33,0.67])
demo.add_admixture(time=239, derived="admixn", ancestral=["admixd","Rrrr"], proportions=[0.29,0.71])
demo.add_admixture(time=117, derived="admixo", ancestral=["admixod","Rllrx"], proportions=[0.39,0.61])
demo.add_admixture(time=239, derived="admixod", ancestral=["Rrfmvp","Rx"], proportions=[0.37,0.63])
demo.add_admixture(time=239, derived="admixou", ancestral=["Rrfmvp","admixz"], proportions=[0.63,0.37])
demo.add_admixture(time=327, derived="admixr", ancestral=["Rrlr","Rrlt"], proportions=[0.17,0.83])
demo.add_admixture(time=327, derived="admixy", ancestral=["Rrlt","Rlllk"], proportions=[0.57,0.43])
demo.add_admixture(time=350, derived="admixz", ancestral=["Rrfm","Rllr"], proportions=[0.68,0.32])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_27/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_27/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_27/qpadm_sim_' + sim_id + '.ind', 'w') as f:
