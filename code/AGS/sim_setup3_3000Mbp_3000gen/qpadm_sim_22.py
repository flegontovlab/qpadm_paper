...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("F", "L", "I", "G", "B", "M", "H", "D", "J", "A", "E", "C", "K"), (2494, 1395, 1744, 2070, 1841, 836, 0, 836, 836, 446, 1395, 836, 1395) )]
...
demo.add_population_split(time=2936, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2599, ancestral="Rl", derived=["F","Rlc"])
demo.add_population_split(time=2494, ancestral="Rlc", derived=["Rlt"])
demo.add_population_split(time=1946, ancestral="Rlr", derived=["Rlrr","Rlre"])
demo.add_population_split(time=1841, ancestral="Rlre", derived=["Rlrex"])
demo.add_population_split(time=1744, ancestral="Rlrex", derived=["Rlrexp"])
demo.add_population_split(time=1841, ancestral="Rlrr", derived=["Rlrrl","I"])
demo.add_population_split(time=1744, ancestral="Rlrrl", derived=["L","Rlrrlr"])
demo.add_population_split(time=1395, ancestral="Rlrrlr", derived=["Rlrrlrw"])
demo.add_population_split(time=1204, ancestral="Rlrrlrw", derived=["M"])
demo.add_population_split(time=2070, ancestral="Rlt", derived=["Rlr","Rltn"])
demo.add_population_split(time=2599, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=2494, ancestral="Rrl", derived=["G"])
demo.add_population_split(time=2494, ancestral="Rrr", derived=["Rrrr","Rrrn"])
demo.add_population_split(time=2070, ancestral="Rrrn", derived=["Rrrno"])
demo.add_population_split(time=1946, ancestral="Rrrno", derived=["Rrrl"])
demo.add_population_split(time=2070, ancestral="Rrrr", derived=["Rrrrr"])
demo.add_population_split(time=1946, ancestral="Rrrrr", derived=["B"])
demo.add_population_split(time=101, ancestral="admix", derived=["H"])
demo.add_population_split(time=1204, ancestral="admixa", derived=["J"])
demo.add_population_split(time=1744, ancestral="admixb", derived=["E"])
demo.add_population_split(time=1204, ancestral="admixc", derived=["D"])
demo.add_population_split(time=1204, ancestral="admixl", derived=["C"])
demo.add_population_split(time=836, ancestral="admixt", derived=["A"])
demo.add_population_split(time=1744, ancestral="admixx", derived=["K"])
demo.add_population_split(time=1744, ancestral="admixy", derived=["admixyp"])
demo.add_admixture(time=101, derived="admix", ancestral=["admixj","admixyp"], proportions=[0.43,0.57])
demo.add_admixture(time=1204, derived="admixa", ancestral=["Rlrexp","Rrrr"], proportions=[0.45,0.55])
demo.add_admixture(time=1744, derived="admixb", ancestral=["Rrrl","Rlc"], proportions=[0.81,0.19])
demo.add_admixture(time=1204, derived="admixc", ancestral=["Rlrrlr","Rrrn"], proportions=[0.26,0.74])
demo.add_admixture(time=1204, derived="admixh", ancestral=["Rlrexp","Rrrno"], proportions=[0.46,0.54])
demo.add_admixture(time=836, derived="admixj", ancestral=["Rlrrlrw","Rlrex"], proportions=[0.54,0.46])
demo.add_admixture(time=1204, derived="admixl", ancestral=["admixyp","Rrrrr"], proportions=[0.44,0.56])
demo.add_admixture(time=836, derived="admixt", ancestral=["admixh","Rrl"], proportions=[0.34,0.66])
demo.add_admixture(time=1744, derived="admixx", ancestral=["Rlre","Rltn"], proportions=[0.43,0.57])
demo.add_admixture(time=1744, derived="admixy", ancestral=["Rrrl","Rltn"], proportions=[0.72,0.28])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_22/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_22/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_22/qpadm_sim_' + sim_id + '.ind', 'w') as f:
