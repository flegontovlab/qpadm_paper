...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("D", "A", "L", "G", "B", "J", "K", "E", "H", "F", "I", "C", "M"), (1699, 1436, 1436, 930, 1699, 2070, 484, 195, 1436, 484, 484, 0, 1065) )]
...
demo.add_population_split(time=2839, ancestral="R", derived=["Rr","Rg"])
demo.add_population_split(time=2494, ancestral="Rg", derived=["Rl"])
demo.add_population_split(time=2070, ancestral="Rl", derived=["Rll","Rla"])
demo.add_population_split(time=1879, ancestral="Rla", derived=["Rlr"])
demo.add_population_split(time=1879, ancestral="Rll", derived=["D","Rllr"])
demo.add_population_split(time=1699, ancestral="Rllr", derived=["Rllrd"])
demo.add_population_split(time=1605, ancestral="Rllrd", derived=["H","Rllrdn"])
demo.add_population_split(time=1436, ancestral="Rllrdn", derived=["Rllrdno"])
demo.add_population_split(time=1699, ancestral="Rlr", derived=["Rlrl","Rlrr"])
demo.add_population_split(time=1605, ancestral="Rlrl", derived=["A","Rlrlh"])
demo.add_population_split(time=1436, ancestral="Rlrlh", derived=["Rlrlhm"])
demo.add_population_split(time=1279, ancestral="Rlrlhm", derived=["M"])
demo.add_population_split(time=1605, ancestral="Rlrr", derived=["L","Rlrrh"])
demo.add_population_split(time=2494, ancestral="Rr", derived=["Rrl","J"])
demo.add_population_split(time=2070, ancestral="Rrl", derived=["Rrlr"])
demo.add_population_split(time=1065, ancestral="Rrll", derived=["G","Rrllr"])
demo.add_population_split(time=930, ancestral="Rrllr", derived=["Rrllrz"])
demo.add_population_split(time=574, ancestral="Rrllrz", derived=["I"])
demo.add_population_split(time=1879, ancestral="Rrlr", derived=["B"])
demo.add_population_split(time=1279, ancestral="admix", derived=["Rrll"])
demo.add_population_split(time=195, ancestral="admixf", derived=["C"])
demo.add_population_split(time=1065, ancestral="admixp", derived=["Rlrrq"])
demo.add_population_split(time=574, ancestral="admixt", derived=["K"])
demo.add_population_split(time=484, ancestral="admixu", derived=["E"])
demo.add_population_split(time=574, ancestral="admixz", derived=["F"])
demo.add_admixture(time=1279, derived="admix", ancestral=["Rlrlh","Rrl"], proportions=[0.37,0.63])
demo.add_admixture(time=195, derived="admixf", ancestral=["Rrllrz","Rlrrq"], proportions=[0.87,0.13])
demo.add_admixture(time=574, derived="admixg", ancestral=["Rrllr","Rllrdno"], proportions=[0.72,0.28])
demo.add_admixture(time=930, derived="admixh", ancestral=["admixv","Rla"], proportions=[0.12,0.88])
demo.add_admixture(time=1279, derived="admixl", ancestral=["Rllrdn","Rrlr"], proportions=[0.4,0.6])
demo.add_admixture(time=1065, derived="admixp", ancestral=["Rlrlhm","Rlrrh"], proportions=[0.13,0.87])
demo.add_admixture(time=574, derived="admixt", ancestral=["Rlrrq","Rllr"], proportions=[0.81,0.19])
demo.add_admixture(time=484, derived="admixu", ancestral=["admixg","Rlrrh"], proportions=[0.35,0.65])
demo.add_admixture(time=1065, derived="admixv", ancestral=["admixl","Rg"], proportions=[0.18,0.82])
demo.add_admixture(time=574, derived="admixz", ancestral=["admixh","Rllrdno"], proportions=[0.46,0.54])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_5/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_5/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_5/qpadm_sim_' + sim_id + '.ind', 'w') as f:
