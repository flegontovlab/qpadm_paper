...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("B", "H", "C", "J", "F", "G", "L", "K", "E", "A", "M", "I", "D"), (1335, 1950, 1335, 1024, 2036, 0, 0, 1590, 1024, 1335, 739, 1691, 739) )]
...
demo.add_population_split(time=2509, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2318, ancestral="Rl", derived=["Rll","Rlr"])
demo.add_population_split(time=2122, ancestral="Rll", derived=["Rllr","Rlln"])
demo.add_population_split(time=2036, ancestral="Rlln", derived=["Rllno"])
demo.add_population_split(time=1950, ancestral="Rllno", derived=["I"])
demo.add_population_split(time=2036, ancestral="Rllr", derived=["H","Rllrlc"])
demo.add_population_split(time=1691, ancestral="Rllrd", derived=["Rllrl"])
demo.add_population_split(time=1590, ancestral="Rllrl", derived=["B","Rllrld"])
demo.add_population_split(time=1950, ancestral="Rllrlc", derived=["Rllrd"])
demo.add_population_split(time=1335, ancestral="Rllrld", derived=["Rllrldd"])
demo.add_population_split(time=1024, ancestral="Rllrldd", derived=["D"])
demo.add_population_split(time=2122, ancestral="Rlr", derived=["Rlrl","F"])
demo.add_population_split(time=2036, ancestral="Rlrl", derived=["Rlrln"])
demo.add_population_split(time=1590, ancestral="Rlrll", derived=["C","Rlrllr"])
demo.add_population_split(time=1335, ancestral="Rlrllr", derived=["J"])
demo.add_population_split(time=2318, ancestral="Rr", derived=["Rrr"])
demo.add_population_split(time=79, ancestral="Rrl", derived=["G","L"])
demo.add_population_split(time=2122, ancestral="Rrr", derived=["Rrrs"])
demo.add_population_split(time=2036, ancestral="Rrrs", derived=["Rrrst"])
demo.add_population_split(time=172, ancestral="admix", derived=["Rrl"])
demo.add_population_split(time=1335, ancestral="admixb", derived=["E"])
demo.add_population_split(time=1691, ancestral="admixe", derived=["Rlrll"])
demo.add_population_split(time=1024, ancestral="admixq", derived=["M"])
demo.add_population_split(time=1590, ancestral="admixu", derived=["A"])
demo.add_population_split(time=1950, ancestral="admixw", derived=["admixwi"])
demo.add_population_split(time=1691, ancestral="admixwi", derived=["K"])
demo.add_admixture(time=172, derived="admix", ancestral=["admixqy","Rr"], proportions=[0.47,0.53])
demo.add_admixture(time=1335, derived="admixb", ancestral=["admixwi","admixwx"], proportions=[0.41,0.59])
demo.add_admixture(time=1691, derived="admixe", ancestral=["Rlrln","Rllrlc"], proportions=[0.61,0.39])
demo.add_admixture(time=1024, derived="admixem", ancestral=["Rllrld","Rllno"], proportions=[0.58,0.42])
demo.add_admixture(time=739, derived="admixn", ancestral=["admixem","Rrrs"], proportions=[0.26,0.74])
demo.add_admixture(time=1024, derived="admixq", ancestral=["Rlrllr","Rlrln"], proportions=[0.43,0.57])
demo.add_admixture(time=536, derived="admixqy", ancestral=["admixn","Rllrldd"], proportions=[0.48,0.52])
demo.add_admixture(time=1590, derived="admixu", ancestral=["Rllrd","Rrrst"], proportions=[0.46,0.54])
demo.add_admixture(time=1950, derived="admixw", ancestral=["Rlln","Rrr"], proportions=[0.18,0.82])
demo.add_admixture(time=1691, derived="admixwx", ancestral=["Rrrst","Rlrl"], proportions=[0.64,0.36])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_10/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_10/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_10/qpadm_sim_' + sim_id + '.ind', 'w') as f:
