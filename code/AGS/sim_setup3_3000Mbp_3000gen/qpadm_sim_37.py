...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("C", "I", "K", "G", "L", "A", "E", "H", "D", "J", "F", "B", "M"), (199, 0, 0, 814, 1106, 1106, 311, 398, 398, 0, 0, 199, 199) )]
...
demo.add_population_split(time=1912, ancestral="R", derived=["Rl","Ro"])
demo.add_population_split(time=1826, ancestral="Rl", derived=["Rll","Rlr"])
demo.add_population_split(time=1410, ancestral="Rll", derived=["Rlll","Rlli"])
demo.add_population_split(time=1106, ancestral="Rlli", derived=["Rllr"])
demo.add_population_split(time=1106, ancestral="Rlll", derived=["Rlllk"])
demo.add_population_split(time=934, ancestral="Rlllk", derived=["Rlllkm"])
demo.add_population_split(time=814, ancestral="Rlllkm", derived=["Rlllkt"])
demo.add_population_split(time=739, ancestral="Rlllkt", derived=["H"])
demo.add_population_split(time=934, ancestral="Rllr", derived=["G"])
demo.add_population_split(time=311, ancestral="Rllrl", derived=["C","Rllrlr"])
demo.add_population_split(time=199, ancestral="Rllrlr", derived=["I","K"])
demo.add_population_split(time=1410, ancestral="Rlr", derived=["L"])
demo.add_population_split(time=739, ancestral="Rlry", derived=["Rlrr"])
demo.add_population_split(time=1826, ancestral="Ro", derived=["Rr"])
demo.add_population_split(time=1410, ancestral="Rr", derived=["A","Rrm"])
demo.add_population_split(time=1106, ancestral="Rrm", derived=["Rrr"])
demo.add_population_split(time=934, ancestral="Rrr", derived=["Rrrw"])
demo.add_population_split(time=398, ancestral="Rrrl", derived=["E"])
demo.add_population_split(time=739, ancestral="Rrrm", derived=["D","Rrrmj"])
demo.add_population_split(time=814, ancestral="Rrrw", derived=["Rrrm"])
demo.add_population_split(time=739, ancestral="admixe", derived=["Rrrl"])
demo.add_population_split(time=311, ancestral="admixh", derived=["M"])
demo.add_population_split(time=199, ancestral="admixj", derived=["F"])
demo.add_population_split(time=398, ancestral="admixl", derived=["Rllrl"])
demo.add_population_split(time=814, ancestral="admixo", derived=["Rlry"])
demo.add_population_split(time=311, ancestral="admixr", derived=["B"])
demo.add_population_split(time=199, ancestral="admixy", derived=["J"])
demo.add_admixture(time=398, derived="admix", ancestral=["Rlry","Rlll"], proportions=[0.66,0.34])
demo.add_admixture(time=814, derived="admixb", ancestral=["Rllr","Rlllk"], proportions=[0.8,0.2])
demo.add_admixture(time=739, derived="admixe", ancestral=["Rlllkm","Rrr"], proportions=[0.42,0.58])
demo.add_admixture(time=311, derived="admixh", ancestral=["Rlrr","Rrrw"], proportions=[0.49,0.51])
demo.add_admixture(time=199, derived="admixj", ancestral=["Rlrr","Rrrmj"], proportions=[0.45,0.55])
demo.add_admixture(time=398, derived="admixl", ancestral=["Rlllkt","admixb"], proportions=[0.77,0.23])
demo.add_admixture(time=814, derived="admixo", ancestral=["admixyd","Rrm"], proportions=[0.1,0.9])
demo.add_admixture(time=311, derived="admixr", ancestral=["admix","Ro"], proportions=[0.43,0.57])
demo.add_admixture(time=199, derived="admixy", ancestral=["Rrrl","Rrrmj"], proportions=[0.24,0.76])
demo.add_admixture(time=934, derived="admixyd", ancestral=["Rlli","Rlr"], proportions=[0.47,0.53])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_37/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_37/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_37/qpadm_sim_' + sim_id + '.ind', 'w') as f:
