...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("A", "B", "I", "H", "L", "C", "E", "K", "J", "G", "F", "M", "D"), (236, 236, 1414, 326, 608, 1504, 75, 326, 75, 1414, 461, 0, 461) )]
...
demo.add_population_split(time=2351, ancestral="R", derived=["Rr","Rk"])
demo.add_population_split(time=2194, ancestral="Rk", derived=["Rl"])
demo.add_population_split(time=1890, ancestral="Rl", derived=["Rlr","Rlz"])
demo.add_population_split(time=326, ancestral="Rll", derived=["A","B"])
demo.add_population_split(time=1504, ancestral="Rlr", derived=["I"])
demo.add_population_split(time=2194, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=1890, ancestral="Rrl", derived=["Rrll","Rrli"])
demo.add_population_split(time=1504, ancestral="Rrli", derived=["Rrlk","Rrlio"])
demo.add_population_split(time=1414, ancestral="Rrlk", derived=["Rrlr"])
demo.add_population_split(time=461, ancestral="Rrlll", derived=["H","Rrlllr"])
demo.add_population_split(time=904, ancestral="Rrlly", derived=["Rrllz"])
demo.add_population_split(time=608, ancestral="Rrllz", derived=["Rrlll"])
demo.add_population_split(time=1050, ancestral="Rrlr", derived=["Rrlrl","Rrlrr"])
demo.add_population_split(time=904, ancestral="Rrlrr", derived=["L","Rrlrre"])
demo.add_population_split(time=608, ancestral="Rrlrre", derived=["F"])
demo.add_population_split(time=1890, ancestral="Rrr", derived=["C","Rrrk"])
demo.add_population_split(time=1504, ancestral="Rrrk", derived=["G"])
demo.add_population_split(time=236, ancestral="admix", derived=["E"])
demo.add_population_split(time=75, ancestral="admixc", derived=["M"])
demo.add_population_split(time=461, ancestral="admixh", derived=["Rll"])
demo.add_population_split(time=461, ancestral="admixo", derived=["K"])
demo.add_population_split(time=1050, ancestral="admixp", derived=["Rrlly"])
demo.add_population_split(time=608, ancestral="admixsg", derived=["D"])
demo.add_population_split(time=236, ancestral="admixv", derived=["J"])
demo.add_admixture(time=236, derived="admix", ancestral=["Rrlllr","Rk"], proportions=[0.86,0.14])
demo.add_admixture(time=75, derived="admixc", ancestral=["admixpb","Rrll"], proportions=[0.27,0.73])
demo.add_admixture(time=461, derived="admixh", ancestral=["Rrlrre","Rlz"], proportions=[0.86,0.14])
demo.add_admixture(time=461, derived="admixo", ancestral=["admixs","Rlz"], proportions=[0.36,0.64])
demo.add_admixture(time=1050, derived="admixp", ancestral=["Rrlio","Rrll"], proportions=[0.41,0.59])
demo.add_admixture(time=236, derived="admixpb", ancestral=["Rrlllr","Rrlio"], proportions=[0.79,0.21])
demo.add_admixture(time=608, derived="admixs", ancestral=["Rrlrl","Rrrk"], proportions=[0.18,0.82])
demo.add_admixture(time=608, derived="admixsg", ancestral=["Rrlly","Rlr"], proportions=[0.53,0.47])
demo.add_admixture(time=236, derived="admixv", ancestral=["admixvc","Rrlrl"], proportions=[0.2,0.8])
demo.add_admixture(time=461, derived="admixvc", ancestral=["Rrllz","Rrlk"], proportions=[0.83,0.17])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_16/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_16/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_16/qpadm_sim_' + sim_id + '.ind', 'w') as f:
