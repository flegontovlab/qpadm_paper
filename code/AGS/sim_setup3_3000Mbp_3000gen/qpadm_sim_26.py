...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("F", "K", "C", "D", "M", "I", "G", "B", "J", "H", "L", "E", "A"), (1372, 739, 2160, 1909, 1909, 1909, 0, 1909, 1024, 1470, 821, 139, 0) )]
...
demo.add_population_split(time=2929, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2632, ancestral="Rl", derived=["Rll","Rlr"])
demo.add_population_split(time=2370, ancestral="Rll", derived=["Rlll","Rllm"])
demo.add_population_split(time=1909, ancestral="Rllf", derived=["Rllfn"])
demo.add_population_split(time=2160, ancestral="Rlll", derived=["Rlllg"])
demo.add_population_split(time=1470, ancestral="Rllll", derived=["F","Rlllle"])
demo.add_population_split(time=1372, ancestral="Rlllr", derived=["Rlllri"])
demo.add_population_split(time=1024, ancestral="Rlllri", derived=["Rlllrr"])
demo.add_population_split(time=821, ancestral="Rlllrr", derived=["K"])
demo.add_population_split(time=2160, ancestral="Rllm", derived=["Rllf"])
demo.add_population_split(time=2370, ancestral="Rlr", derived=["C","Rlrr"])
demo.add_population_split(time=2160, ancestral="Rlrr", derived=["D","M"])
demo.add_population_split(time=2632, ancestral="Rr", derived=["Rrr","Rrh"])
demo.add_population_split(time=2160, ancestral="Rre", derived=["B"])
demo.add_population_split(time=2370, ancestral="Rrh", derived=["Rre"])
demo.add_population_split(time=2370, ancestral="Rrr", derived=["Rrrl"])
demo.add_population_split(time=2160, ancestral="Rrrl", derived=["I","Rrrlz"])
demo.add_population_split(time=1909, ancestral="Rrrlz", derived=["H"])
demo.add_population_split(time=739, ancestral="admix", derived=["admixw"])
demo.add_population_split(time=1024, ancestral="admixf", derived=["L"])
demo.add_population_split(time=1372, ancestral="admixj", derived=["J"])
demo.add_population_split(time=1470, ancestral="admixjv", derived=["Rlllr"])
demo.add_population_split(time=139, ancestral="admixp", derived=["A"])
demo.add_population_split(time=1909, ancestral="admixv", derived=["Rllll"])
demo.add_population_split(time=360, ancestral="admixw", derived=["E"])
demo.add_population_split(time=139, ancestral="admixx", derived=["G"])
demo.add_admixture(time=739, derived="admix", ancestral=["Rlllrr","Rllfn"], proportions=[0.53,0.47])
demo.add_admixture(time=1470, derived="admixa", ancestral=["Rllf","Rre"], proportions=[0.41,0.59])
demo.add_admixture(time=821, derived="admixe", ancestral=["Rlllri","Rlllg"], proportions=[0.8,0.2])
demo.add_admixture(time=1024, derived="admixf", ancestral=["Rlllr","Rlllle"], proportions=[0.87,0.13])
demo.add_admixture(time=1372, derived="admixj", ancestral=["admixa","Rllm"], proportions=[0.29,0.71])
demo.add_admixture(time=1470, derived="admixjv", ancestral=["Rlllg","Rrrlz"], proportions=[0.48,0.52])
demo.add_admixture(time=139, derived="admixp", ancestral=["admixw","Rrr"], proportions=[0.13,0.87])
demo.add_admixture(time=1909, derived="admixv", ancestral=["Rlll","Rrh"], proportions=[0.38,0.62])
demo.add_admixture(time=739, derived="admixvl", ancestral=["admixe","Rllfn"], proportions=[0.37,0.63])
demo.add_admixture(time=139, derived="admixx", ancestral=["admixvl","Rlllle"], proportions=[0.46,0.54])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_26/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_26/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_26/qpadm_sim_' + sim_id + '.ind', 'w') as f:
