...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("B", "M", "F", "D", "J", "L", "E", "C", "G", "I", "H", "A", "K"), (2516, 1144, 1372, 1462, 1732, 1372, 1144, 375, 2516, 1372, 1372, 0, 1372) )]
...
demo.add_population_split(time=3000, ancestral="R", derived=["Rl","Rd"])
demo.add_population_split(time=2850, ancestral="Rd", derived=["Rr"])
demo.add_population_split(time=2850, ancestral="Rl", derived=["Rlr","Rlrc"])
demo.add_population_split(time=2678, ancestral="Rlr", derived=["B"])
demo.add_population_split(time=2678, ancestral="Rlrc", derived=["G"])
demo.add_population_split(time=2678, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=2516, ancestral="Rrl", derived=["Rrlr","Rrlg"])
demo.add_population_split(time=2092, ancestral="Rrlr", derived=["Rrlrl","Rrlrb"])
demo.add_population_split(time=1732, ancestral="Rrlrb", derived=["Rrlrbx"])
demo.add_population_split(time=1732, ancestral="Rrlrl", derived=["Rrlrll","Rrlrlh"])
demo.add_population_split(time=1462, ancestral="Rrlrlh", derived=["L"])
demo.add_population_split(time=1462, ancestral="Rrlrll", derived=["Rrlrlll","F"])
demo.add_population_split(time=1372, ancestral="Rrlrlll", derived=["M"])
demo.add_population_split(time=2516, ancestral="Rrr", derived=["Rrrl","Rrro"])
demo.add_population_split(time=2092, ancestral="Rrrl", derived=["Rrrll","J"])
demo.add_population_split(time=1732, ancestral="Rrrll", derived=["D","Rrrllm"])
demo.add_population_split(time=1462, ancestral="Rrrllm", derived=["I"])
demo.add_population_split(time=2092, ancestral="Rrro", derived=["Rrroj","Rrroh"])
demo.add_population_split(time=1372, ancestral="admix", derived=["E"])
demo.add_population_split(time=1462, ancestral="admixj", derived=["H"])
demo.add_population_split(time=150, ancestral="admixk", derived=["A"])
demo.add_population_split(time=788, ancestral="admixo", derived=["C"])
demo.add_population_split(time=1462, ancestral="admixw", derived=["K"])
demo.add_admixture(time=1372, derived="admix", ancestral=["Rrlrlh","Rrlrbx"], proportions=[0.61,0.39])
demo.add_admixture(time=1732, derived="admixc", ancestral=["Rrlg","Rlrc"], proportions=[0.64,0.36])
demo.add_admixture(time=1144, derived="admixi", ancestral=["Rrlrlll","Rrrllm"], proportions=[0.32,0.68])
demo.add_admixture(time=1372, derived="admixic", ancestral=["Rrlrbx","Rrroh"], proportions=[0.3,0.7])
demo.add_admixture(time=1462, derived="admixj", ancestral=["Rrlrb","Rrroh"], proportions=[0.3,0.7])
demo.add_admixture(time=150, derived="admixk", ancestral=["admixm","admixc"], proportions=[0.89,0.11])
demo.add_admixture(time=1144, derived="admixm", ancestral=["admixic","Rd"], proportions=[0.22,0.78])
demo.add_admixture(time=788, derived="admixo", ancestral=["admixv","Rrroj"], proportions=[0.21,0.79])
demo.add_admixture(time=956, derived="admixv", ancestral=["admixi","Rrlg"], proportions=[0.21,0.79])
demo.add_admixture(time=1462, derived="admixw", ancestral=["Rrroj","Rlr"], proportions=[0.58,0.42])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_12/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_12/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_12/qpadm_sim_' + sim_id + '.ind', 'w') as f:
