...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("K", "A", "E", "J", "H", "B", "G", "C", "L", "D", "F", "I", "M"), (1748, 750, 2408, 2310, 2310, 124, 368, 0, 210, 0, 1748, 210, 0) )]
...
demo.add_population_split(time=2756, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2490, ancestral="Rl", derived=["Rll","E"])
demo.add_population_split(time=2408, ancestral="Rll", derived=["Rlll","Rllr"])
demo.add_population_split(time=2310, ancestral="Rlll", derived=["Rllll","Rlllr"])
demo.add_population_split(time=2138, ancestral="Rllll", derived=["K","Rlllls"])
demo.add_population_split(time=750, ancestral="Rllllr", derived=["Rllllrd","Rllllrf"])
demo.add_population_split(time=600, ancestral="Rllllrf", derived=["Rllllrs"])
demo.add_population_split(time=368, ancestral="Rllllrs", derived=["L","Rllllrsl"])
demo.add_population_split(time=2138, ancestral="Rlllr", derived=["Rlllrl"])
demo.add_population_split(time=1046, ancestral="Rlllrlr", derived=["A","Rlllrlrm"])
demo.add_population_split(time=750, ancestral="Rlllrlrm", derived=["Rlllrlry"])
demo.add_population_split(time=600, ancestral="Rlllrlry", derived=["G"])
demo.add_population_split(time=2310, ancestral="Rllr", derived=["Rllra"])
demo.add_population_split(time=2490, ancestral="Rr", derived=["Rrl","Rrp"])
demo.add_population_split(time=2408, ancestral="Rrl", derived=["J","H"])
demo.add_population_split(time=210, ancestral="admix", derived=["B"])
demo.add_population_split(time=1361, ancestral="admixi", derived=["admixiu"])
demo.add_population_split(time=1046, ancestral="admixiu", derived=["Rllllr"])
demo.add_population_split(time=124, ancestral="admixk", derived=["D"])
demo.add_population_split(time=2138, ancestral="admixu", derived=["F"])
demo.add_population_split(time=124, ancestral="admixw", derived=["C"])
demo.add_population_split(time=368, ancestral="admixwh", derived=["I"])
demo.add_population_split(time=1361, ancestral="admixy", derived=["Rlllrlr"])
demo.add_population_split(time=124, ancestral="admixz", derived=["M"])
demo.add_admixture(time=210, derived="admix", ancestral=["admixe","Rlllr"], proportions=[0.5,0.5])
demo.add_admixture(time=750, derived="admixd", ancestral=["admixiu","Rlllrl"], proportions=[0.36,0.64])
demo.add_admixture(time=368, derived="admixe", ancestral=["Rllllrd","Rlllrlrm"], proportions=[0.3,0.7])
demo.add_admixture(time=1361, derived="admixi", ancestral=["Rlllls","Rllra"], proportions=[0.33,0.67])
demo.add_admixture(time=124, derived="admixk", ancestral=["Rllllrsl","Rllllrd"], proportions=[0.76,0.24])
demo.add_admixture(time=2138, derived="admixu", ancestral=["Rllr","Rrp"], proportions=[0.22,0.78])
demo.add_admixture(time=124, derived="admixw", ancestral=["Rlllrlry","admixd"], proportions=[0.6,0.4])
demo.add_admixture(time=368, derived="admixwh", ancestral=["Rllllrf","Rllra"], proportions=[0.2,0.8])
demo.add_admixture(time=1361, derived="admixy", ancestral=["Rlllrl","Rlllls"], proportions=[0.77,0.23])
demo.add_admixture(time=124, derived="admixz", ancestral=["Rllllrsl","Rrp"], proportions=[0.25,0.75])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_24/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_24/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_24/qpadm_sim_' + sim_id + '.ind', 'w') as f:
