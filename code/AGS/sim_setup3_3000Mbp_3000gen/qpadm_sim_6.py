...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("L", "A", "I", "C", "F", "K", "B", "M", "E", "H", "J", "D", "G"), (562, 686, 836, 562, 562, 2002, 2002, 1204, 1204, 199, 1125, 0, 0) )]
...
demo.add_population_split(time=2445, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2276, ancestral="Rl", derived=["Rlr","Rli"])
demo.add_population_split(time=2149, ancestral="Rli", derived=["B"])
demo.add_population_split(time=2149, ancestral="Rlr", derived=["Rlrl","Rlrr"])
demo.add_population_split(time=836, ancestral="Rlrll", derived=["Rlrlll","A"])
demo.add_population_split(time=686, ancestral="Rlrlll", derived=["L"])
demo.add_population_split(time=2002, ancestral="Rlrr", derived=["Rlrrt"])
demo.add_population_split(time=1125, ancestral="Rlrrr", derived=["I"])
demo.add_population_split(time=1609, ancestral="Rlrrt", derived=["Rlrrti"])
demo.add_population_split(time=1204, ancestral="Rlrrti", derived=["J"])
demo.add_population_split(time=2276, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=2149, ancestral="Rrl", derived=["Rrls"])
demo.add_population_split(time=686, ancestral="Rrlr", derived=["C","F"])
demo.add_population_split(time=2149, ancestral="Rrr", derived=["K","Rrra"])
demo.add_population_split(time=2002, ancestral="Rrra", derived=["Rrrah"])
demo.add_population_split(time=1609, ancestral="Rrrah", derived=["Rrraho"])
demo.add_population_split(time=1204, ancestral="Rrraho", derived=["Rrrahoe"])
demo.add_population_split(time=1609, ancestral="admix", derived=["M"])
demo.add_population_split(time=1609, ancestral="admixa", derived=["E"])
demo.add_population_split(time=1204, ancestral="admixe", derived=["admixei"])
demo.add_population_split(time=1125, ancestral="admixei", derived=["Rlrll"])
demo.add_population_split(time=562, ancestral="admixel", derived=["admixell"])
demo.add_population_split(time=469, ancestral="admixeo", derived=["H"])
demo.add_population_split(time=199, ancestral="admixj", derived=["G"])
demo.add_population_split(time=836, ancestral="admixr", derived=["Rrlr"])
demo.add_population_split(time=199, ancestral="admixt", derived=["D"])
demo.add_population_split(time=1204, ancestral="admixv", derived=["Rlrrr"])
demo.add_admixture(time=1609, derived="admix", ancestral=["Rrra","Rli"], proportions=[0.54,0.46])
demo.add_admixture(time=1609, derived="admixa", ancestral=["Rlrl","Rrls"], proportions=[0.16,0.84])
demo.add_admixture(time=1204, derived="admixe", ancestral=["Rlrrt","Rlrl"], proportions=[0.88,0.12])
demo.add_admixture(time=562, derived="admixel", ancestral=["Rlrlll","admixei"], proportions=[0.54,0.46])
demo.add_admixture(time=469, derived="admixeo", ancestral=["admixq","Rrraho"], proportions=[0.29,0.71])
demo.add_admixture(time=199, derived="admixj", ancestral=["admixell","Rlrrr"], proportions=[0.22,0.78])
demo.add_admixture(time=836, derived="admixq", ancestral=["Rrrahoe","Rrl"], proportions=[0.8,0.2])
demo.add_admixture(time=836, derived="admixr", ancestral=["Rrrahoe","Rrls"], proportions=[0.52,0.48])
demo.add_admixture(time=199, derived="admixt", ancestral=["admixell","Rlrrti"], proportions=[0.41,0.59])
demo.add_admixture(time=1204, derived="admixv", ancestral=["Rrrah","Rlrr"], proportions=[0.55,0.45])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_6/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_6/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_6/qpadm_sim_' + sim_id + '.ind', 'w') as f:
