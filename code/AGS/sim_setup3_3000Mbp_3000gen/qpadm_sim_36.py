...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("H", "E", "D", "J", "I", "M", "A", "L", "B", "F", "G", "K", "C"), (1616, 1616, 2182, 2182, 1729, 0, 788, 998, 1980, 1729, 788, 788, 428) )]
...
demo.add_population_split(time=2906, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2681, ancestral="Rl", derived=["Rlr","Rlo"])
demo.add_population_split(time=2182, ancestral="Rll", derived=["Rlll","Rlld"])
demo.add_population_split(time=1980, ancestral="Rlld", derived=["I"])
demo.add_population_split(time=1980, ancestral="Rlll", derived=["Rlllrt","Rllly"])
demo.add_population_split(time=1616, ancestral="Rlllr", derived=["Rlllrw"])
demo.add_population_split(time=1729, ancestral="Rlllrt", derived=["Rlllr"])
demo.add_population_split(time=1391, ancestral="Rlllrw", derived=["Rlllrwi"])
demo.add_population_split(time=998, ancestral="Rlllrwi", derived=["K"])
demo.add_population_split(time=2599, ancestral="Rlo", derived=["Rll","Rloc"])
demo.add_population_split(time=2599, ancestral="Rlr", derived=["Rlrd"])
demo.add_population_split(time=2182, ancestral="Rlrd", derived=["Rlrdd"])
demo.add_population_split(time=1980, ancestral="Rlrdd", derived=["Rlrl"])
demo.add_population_split(time=1729, ancestral="Rlrl", derived=["H","E"])
demo.add_population_split(time=2681, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=2599, ancestral="Rrl", derived=["D","J"])
demo.add_population_split(time=2599, ancestral="Rrr", derived=["Rrrl","Rrrg"])
demo.add_population_split(time=2182, ancestral="Rrrg", derived=["B"])
demo.add_population_split(time=1616, ancestral="admix", derived=["Rllll"])
demo.add_population_split(time=998, ancestral="admixe", derived=["A"])
demo.add_population_split(time=428, ancestral="admixh", derived=["M"])
demo.add_population_split(time=998, ancestral="admixi", derived=["G"])
demo.add_population_split(time=1391, ancestral="admixm", derived=["L"])
demo.add_population_split(time=1980, ancestral="admixvt", derived=["F"])
demo.add_population_split(time=788, ancestral="admixy", derived=["C"])
demo.add_admixture(time=1616, derived="admix", ancestral=["Rllly","Rlld"], proportions=[0.6,0.4])
demo.add_admixture(time=998, derived="admixe", ancestral=["Rllll","Rlrd"], proportions=[0.46,0.54])
demo.add_admixture(time=428, derived="admixh", ancestral=["admixq","Rllll"], proportions=[0.12,0.88])
demo.add_admixture(time=998, derived="admixi", ancestral=["Rlllr","admixn"], proportions=[0.78,0.22])
demo.add_admixture(time=1391, derived="admixm", ancestral=["admixv","Rrrl"], proportions=[0.44,0.56])
demo.add_admixture(time=1729, derived="admixn", ancestral=["Rlrdd","Rloc"], proportions=[0.81,0.19])
demo.add_admixture(time=998, derived="admixq", ancestral=["Rlllrw","Rlllrt"], proportions=[0.51,0.49])
demo.add_admixture(time=1616, derived="admixv", ancestral=["Rllly","Rrrg"], proportions=[0.38,0.62])
demo.add_admixture(time=1980, derived="admixvt", ancestral=["Rrrl","Rloc"], proportions=[0.8,0.2])
demo.add_admixture(time=788, derived="admixy", ancestral=["Rlllrwi","Rlr"], proportions=[0.43,0.57])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_36/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_36/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_36/qpadm_sim_' + sim_id + '.ind', 'w') as f:
