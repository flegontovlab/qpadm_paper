...
numpy.savetxt('./projects/qpadm/results/simout/deep/qpadm_sim_4.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/deep/qpadm_sim_4.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/deep/qpadm_sim_4.ind', 'w') as f:
