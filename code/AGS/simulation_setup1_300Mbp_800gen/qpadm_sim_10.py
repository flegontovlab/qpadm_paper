...
numpy.savetxt('./projects/qpadm/results/simout/3chr/sim_10/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/3chr/sim_10/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/3chr/sim_10/qpadm_sim_' + sim_id + '.ind', 'w') as f:
