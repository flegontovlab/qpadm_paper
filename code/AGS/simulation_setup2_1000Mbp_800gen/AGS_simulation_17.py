...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("C", "I", "A", "H", "K", "B", "D", "G", "F", "L", "J", "E", "M"), (571, 485, 135, 135, 110, 410, 410, 0, 110, 233, 410, 135, 0) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_17/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_17/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_17/qpadm_sim_' + sim_id + '.ind', 'w') as f:
