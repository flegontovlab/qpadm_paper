...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("A", "B", "G", "M", "I", "L", "E", "D", "J", "C", "F", "H", "K"), (459, 459, 157, 157, 49, 203, 577, 157, 0, 203, 459, 49, 0) )]
...
demo.add_population_split(time=459, ancestral="admix", derived=["admixr"])
demo.add_population_split(time=49, ancestral="admixd", derived=["K"])
demo.add_population_split(time=203, ancestral="admixg", derived=["D"])
demo.add_population_split(time=262, ancestral="admixl", derived=["C"])
demo.add_population_split(time=262, ancestral="admixlf", derived=["Rrlrl"])
demo.add_population_split(time=285, ancestral="admixq", derived=["Rrll"])
demo.add_population_split(time=435, ancestral="admixr", derived=["Rrlr","admixrb"])
demo.add_population_split(time=396, ancestral="admixrb", derived=["admixrj"])
demo.add_population_split(time=49, ancestral="admixy", derived=["J"])
demo.add_population_split(time=756, ancestral="R", derived=["Rr","Ru"])
demo.add_population_split(time=541, ancestral="Rl", derived=["Rlr","Rln"])
demo.add_population_split(time=513, ancestral="Rln", derived=["F"])
demo.add_population_split(time=513, ancestral="Rlr", derived=["A","B"])
demo.add_population_split(time=647, ancestral="Rr", derived=["E","Rrc"])
demo.add_population_split(time=577, ancestral="Rrc", derived=["Rrl"])
demo.add_population_split(time=541, ancestral="Rrl", derived=["Rrlh"])
demo.add_population_split(time=396, ancestral="Rrlr", derived=["Rrlrr"])
demo.add_population_split(time=203, ancestral="Rrlrl", derived=["G","Rrlrlj"])
demo.add_population_split(time=157, ancestral="Rrlrlj", derived=["H"])
demo.add_population_split(time=285, ancestral="Rrlrr", derived=["Rrlrrl"])
demo.add_population_split(time=262, ancestral="Rrlrrl", derived=["Rrlrrll","L"])
demo.add_population_split(time=203, ancestral="Rrlrrll", derived=["M","Rrlrrllr"])
demo.add_population_split(time=157, ancestral="Rrlrrllr", derived=["I"])
demo.add_population_split(time=647, ancestral="Ru", derived=["Rup","Ruu"])
demo.add_population_split(time=577, ancestral="Rup", derived=["Rl"])
demo.add_admixture(time=459, derived="admix", ancestral=["Rrlh","admixu"], proportions=[0.79,0.21])
demo.add_admixture(time=459, derived="admixa", ancestral=["Rrlh","Ruu"], proportions=[0.42,0.58])
demo.add_admixture(time=49, derived="admixd", ancestral=["Rrlrrllr","Rrlrlj"], proportions=[0.63,0.37])
demo.add_admixture(time=203, derived="admixg", ancestral=["Rrll","Rup"], proportions=[0.26,0.74])
demo.add_admixture(time=435, derived="admixk", ancestral=["admixa","Rln"], proportions=[0.5,0.5])
demo.add_admixture(time=262, derived="admixl", ancestral=["Rrlrr","admixrj"], proportions=[0.53,0.47])
demo.add_admixture(time=262, derived="admixlf", ancestral=["admixrj","Rrlr"], proportions=[0.11,0.89])
demo.add_admixture(time=285, derived="admixq", ancestral=["admixrb","Rrl"], proportions=[0.3,0.7])
demo.add_admixture(time=541, derived="admixu", ancestral=["Ruu","Rrc"], proportions=[0.81,0.19])
demo.add_admixture(time=49, derived="admixy", ancestral=["Rrll","admixk"], proportions=[0.65,0.35])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_1/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_1/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_1/qpadm_sim_' + sim_id + '.ind', 'w') as f:
