...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("B", "I", "G", "L", "M", "E", "H", "D", "C", "J", "A", "K", "F"), (726, 306, 166, 372, 372, 402, 41, 402, 41, 88, 615, 0, 64) )]
...
demo.add_population_split(time=372, ancestral="admix", derived=["admixj"])
demo.add_population_split(time=64, ancestral="admixd", derived=["H"])
demo.add_population_split(time=402, ancestral="admixk", derived=["Rrllrl"])
demo.add_population_split(time=41, ancestral="admixl", derived=["K"])
demo.add_population_split(time=464, ancestral="admixm", derived=["D"])
demo.add_population_split(time=88, ancestral="admixs", derived=["F"])
demo.add_population_split(time=306, ancestral="admixw", derived=["Rrlrlll"])
demo.add_population_split(time=166, ancestral="admixwr", derived=["J"])
demo.add_population_split(time=64, ancestral="admixx", derived=["C"])
demo.add_population_split(time=769, ancestral="R", derived=["B","Rr"])
demo.add_population_split(time=726, ancestral="Rr", derived=["Rrl","Rrn"])
demo.add_population_split(time=643, ancestral="Rrl", derived=["Rrll","Rrlr"])
demo.add_population_split(time=615, ancestral="Rrll", derived=["Rrllr"])
demo.add_population_split(time=372, ancestral="Rrllrl", derived=["I","Rrllrls"])
demo.add_population_split(time=615, ancestral="Rrlr", derived=["Rrlrl","Rrlrv"])
demo.add_population_split(time=515, ancestral="Rrlrl", derived=["Rrlrll","Rrlrlr"])
demo.add_population_split(time=464, ancestral="Rrlrll", derived=["Rrlrllj"])
demo.add_population_split(time=402, ancestral="Rrlrllj", derived=["M"])
demo.add_population_split(time=235, ancestral="Rrlrlll", derived=["G","Rrlrlllk"])
demo.add_population_split(time=166, ancestral="Rrlrlllk", derived=["Rrlrlllkm"])
demo.add_population_split(time=464, ancestral="Rrlrlr", derived=["Rrlrlrl","Rrlrlrw"])
demo.add_population_split(time=402, ancestral="Rrlrlrl", derived=["L","Rrlrlrlp"])
demo.add_population_split(time=515, ancestral="Rrlrv", derived=["Rrlry"])
demo.add_population_split(time=464, ancestral="Rrlry", derived=["E"])
demo.add_population_split(time=643, ancestral="Rrn", derived=["A"])
demo.add_admixture(time=372, derived="admix", ancestral=["Rrlrllj","Rrllr"], proportions=[0.8,0.2])
demo.add_admixture(time=64, derived="admixd", ancestral=["Rrlrlllkm","Rrlrlrw"], proportions=[0.36,0.64])
demo.add_admixture(time=235, derived="admixf", ancestral=["Rrllrls","Rrn"], proportions=[0.48,0.52])
demo.add_admixture(time=402, derived="admixk", ancestral=["Rrlry","Rrllr"], proportions=[0.88,0.12])
demo.add_admixture(time=41, derived="admixl", ancestral=["admixf","Rrlrlrlp"], proportions=[0.4,0.6])
demo.add_admixture(time=464, derived="admixm", ancestral=["Rrlrv","Rrll"], proportions=[0.82,0.18])
demo.add_admixture(time=88, derived="admixs", ancestral=["Rrlrlllk","Rrlrlrw"], proportions=[0.3,0.7])
demo.add_admixture(time=306, derived="admixw", ancestral=["Rrlrlrlp","Rrlrll"], proportions=[0.52,0.48])
demo.add_admixture(time=166, derived="admixwr", ancestral=["admixj","Rrllrls"], proportions=[0.29,0.71])
demo.add_admixture(time=64, derived="admixx", ancestral=["Rrlrlllkm","admixj"], proportions=[0.53,0.47])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_4/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_4/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_4/qpadm_sim_' + sim_id + '.ind', 'w') as f:
