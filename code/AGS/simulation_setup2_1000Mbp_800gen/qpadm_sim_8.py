...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("J", "F", "A", "C", "H", "I", "K", "E", "M", "L", "G", "D", "B"), (302, 302, 505, 505, 505, 0, 0, 364, 302, 302, 99, 99, 0) )]
...
demo.add_population_split(time=132, ancestral="admixh", derived=["G"])
demo.add_population_split(time=195, ancestral="admixkk", derived=["Rllr"])
demo.add_population_split(time=545, ancestral="admixl", derived=["Rrrr"])
demo.add_population_split(time=132, ancestral="admixp", derived=["Rrrrl"])
demo.add_population_split(time=99, ancestral="admixr", derived=["B"])
demo.add_population_split(time=714, ancestral="R", derived=["Rr","Rz"])
demo.add_population_split(time=545, ancestral="Rl", derived=["Rli","Rln"])
demo.add_population_split(time=505, ancestral="Rli", derived=["Rll"])
demo.add_population_split(time=411, ancestral="Rll", derived=["Rlll"])
demo.add_population_split(time=364, ancestral="Rlll", derived=["J","F"])
demo.add_population_split(time=160, ancestral="Rllr", derived=["Rllrt"])
demo.add_population_split(time=132, ancestral="Rllrt", derived=["D"])
demo.add_population_split(time=505, ancestral="Rln", derived=["Rlr"])
demo.add_population_split(time=411, ancestral="Rlr", derived=["Rlrj"])
demo.add_population_split(time=364, ancestral="Rlrj", derived=["L"])
demo.add_population_split(time=582, ancestral="Rm", derived=["Rl","Rmv"])
demo.add_population_split(time=680, ancestral="Rr", derived=["Rrr","Rrn"])
demo.add_population_split(time=545, ancestral="Rrl", derived=["A"])
demo.add_population_split(time=582, ancestral="Rrn", derived=["Rrl"])
demo.add_population_split(time=582, ancestral="Rrr", derived=["Rrrl"])
demo.add_population_split(time=545, ancestral="Rrrl", derived=["C","H"])
demo.add_population_split(time=505, ancestral="Rrrr", derived=["Rrrrr"])
demo.add_population_split(time=99, ancestral="Rrrrl", derived=["I","K"])
demo.add_population_split(time=411, ancestral="Rrrrr", derived=["E","Rrrrrj"])
demo.add_population_split(time=364, ancestral="Rrrrrj", derived=["M"])
demo.add_population_split(time=680, ancestral="Rz", derived=["Rm"])
demo.add_admixture(time=252, derived="admix", ancestral=["admixknv","Rll"], proportions=[0.19,0.81])
demo.add_admixture(time=132, derived="admixh", ancestral=["Rllr","Rz"], proportions=[0.31,0.69])
demo.add_admixture(time=302, derived="admixj", ancestral=["Rlrj","Rmv"], proportions=[0.45,0.55])
demo.add_admixture(time=364, derived="admixk", ancestral=["Rlr","Rrrr"], proportions=[0.29,0.71])
demo.add_admixture(time=195, derived="admixkk", ancestral=["admix","Rln"], proportions=[0.42,0.58])
demo.add_admixture(time=302, derived="admixkn", ancestral=["admixk","Rmv"], proportions=[0.32,0.68])
demo.add_admixture(time=302, derived="admixknv", ancestral=["Rrrrrj","Rli"], proportions=[0.74,0.26])
demo.add_admixture(time=545, derived="admixl", ancestral=["Rrr","Rrn"], proportions=[0.66,0.34])
demo.add_admixture(time=132, derived="admixp", ancestral=["admixkn","admixj"], proportions=[0.57,0.43])
demo.add_admixture(time=99, derived="admixr", ancestral=["Rllrt","Rrl"], proportions=[0.2,0.8])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_8/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_8/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_8/qpadm_sim_' + sim_id + '.ind', 'w') as f:
