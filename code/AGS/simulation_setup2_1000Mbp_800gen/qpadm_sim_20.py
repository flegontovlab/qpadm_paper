...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("J", "K", "L", "F", "G", "D", "I", "E", "A", "C", "B", "M", "H"), (445, 178, 526, 604, 241, 311, 139, 0, 241, 139, 74, 74, 44) )]
...
demo.add_population_split(time=311, ancestral="admix", derived=["G"])
demo.add_population_split(time=178, ancestral="admixb", derived=["I"])
demo.add_population_split(time=419, ancestral="admixe", derived=["Rrlly"])
demo.add_population_split(time=44, ancestral="admixh", derived=["E"])
demo.add_population_split(time=311, ancestral="admixi", derived=["A"])
demo.add_population_split(time=74, ancestral="admixl", derived=["H"])
demo.add_population_split(time=311, ancestral="admixn", derived=["Rrlllrlr"])
demo.add_population_split(time=139, ancestral="admixp", derived=["B"])
demo.add_population_split(time=703, ancestral="R", derived=["Rr"])
demo.add_population_split(time=672, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=630, ancestral="Rrl", derived=["Rrll","Rrlr"])
demo.add_population_split(time=604, ancestral="Rrll", derived=["Rrlll"])
demo.add_population_split(time=526, ancestral="Rrlll", derived=["Rrllly","Rrlllq"])
demo.add_population_split(time=470, ancestral="Rrllll", derived=["J","Rrllllc"])
demo.add_population_split(time=445, ancestral="Rrllllc", derived=["Rrllllp"])
demo.add_population_split(time=419, ancestral="Rrllllp", derived=["D"])
demo.add_population_split(time=503, ancestral="Rrlllq", derived=["Rrlllr"])
demo.add_population_split(time=470, ancestral="Rrlllr", derived=["Rrlllrl","Rrlllrlv"])
demo.add_population_split(time=445, ancestral="Rrlllrl", derived=["Rrlllrll"])
demo.add_population_split(time=241, ancestral="Rrlllrlr", derived=["K","Rrlllrlrx"])
demo.add_population_split(time=178, ancestral="Rrlllrlrx", derived=["C"])
demo.add_population_split(time=503, ancestral="Rrllly", derived=["Rrllll"])
demo.add_population_split(time=241, ancestral="Rrlln", derived=["Rrllno"])
demo.add_population_split(time=178, ancestral="Rrllno", derived=["Rrllnoe"])
demo.add_population_split(time=139, ancestral="Rrllnoe", derived=["M"])
demo.add_population_split(time=311, ancestral="Rrlly", derived=["Rrlln"])
demo.add_population_split(time=604, ancestral="Rrlr", derived=["L"])
demo.add_population_split(time=630, ancestral="Rrr", derived=["F"])
demo.add_admixture(time=311, derived="admix", ancestral=["admixa","Rrllly"], proportions=[0.16,0.84])
demo.add_admixture(time=470, derived="admixa", ancestral=["Rrlllq","Rrr"], proportions=[0.44,0.56])
demo.add_admixture(time=178, derived="admixb", ancestral=["Rrlln","Rrlr"], proportions=[0.41,0.59])
demo.add_admixture(time=419, derived="admixe", ancestral=["Rrllllc","Rrll"], proportions=[0.67,0.33])
demo.add_admixture(time=44, derived="admixh", ancestral=["admixm","Rrlly"], proportions=[0.22,0.78])
demo.add_admixture(time=311, derived="admixi", ancestral=["Rrlllrll","Rrlllrlv"], proportions=[0.37,0.63])
demo.add_admixture(time=74, derived="admixl", ancestral=["Rrllnoe","R"], proportions=[0.77,0.23])
demo.add_admixture(time=74, derived="admixm", ancestral=["Rrllno","Rrlllrll"], proportions=[0.83,0.17])
demo.add_admixture(time=311, derived="admixn", ancestral=["Rrllllp","Rrlllrl"], proportions=[0.28,0.72])
demo.add_admixture(time=139, derived="admixp", ancestral=["Rrlllrlrx","Rrlllrlv"], proportions=[0.17,0.83])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_20/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_20/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_20/qpadm_sim_' + sim_id + '.ind', 'w') as f:
