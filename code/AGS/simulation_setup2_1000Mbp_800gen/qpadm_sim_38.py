...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("A", "G", "F", "H", "K", "M", "J", "D", "L", "I", "E", "C", "B"), (497, 523, 423, 464, 464, 423, 252, 497, 252, 0, 118, 183, 0) )]
...
demo.add_population_split(time=464, ancestral="admix", derived=["M"])
demo.add_population_split(time=360, ancestral="admixb", derived=["J"])
demo.add_population_split(time=497, ancestral="admixe", derived=["Rrrlrl"])
demo.add_population_split(time=95, ancestral="admixm", derived=["B"])
demo.add_population_split(time=183, ancestral="admixr", derived=["E"])
demo.add_population_split(time=464, ancestral="admixs", derived=["admixsc"])
demo.add_population_split(time=95, ancestral="admixy", derived=["I"])
demo.add_population_split(time=791, ancestral="R", derived=["Rr"])
demo.add_population_split(time=674, ancestral="Rr", derived=["Rrr","Rrx"])
demo.add_population_split(time=586, ancestral="Rrl", derived=["Rrll","Rrlo"])
demo.add_population_split(time=523, ancestral="Rrll", derived=["A","Rrllv"])
demo.add_population_split(time=497, ancestral="Rrllv", derived=["K"])
demo.add_population_split(time=523, ancestral="Rrlo", derived=["D"])
demo.add_population_split(time=622, ancestral="Rrr", derived=["Rrrl","Rrrn"])
demo.add_population_split(time=586, ancestral="Rrrl", derived=["G","Rrrlr"])
demo.add_population_split(time=464, ancestral="Rrrlrl", derived=["F"])
demo.add_population_split(time=586, ancestral="Rrrn", derived=["Rrrr"])
demo.add_population_split(time=523, ancestral="Rrrr", derived=["Rrrrl","Rrrrr"])
demo.add_population_split(time=497, ancestral="Rrrrl", derived=["Rrrrly"])
demo.add_population_split(time=423, ancestral="Rrrrlr", derived=["Rrrrlru","Rrrrlrd"])
demo.add_population_split(time=360, ancestral="Rrrrlrd", derived=["Rrrrlrt"])
demo.add_population_split(time=252, ancestral="Rrrrlrt", derived=["C","Rrrrlrti"])
demo.add_population_split(time=360, ancestral="Rrrrlru", derived=["L"])
demo.add_population_split(time=464, ancestral="Rrrrly", derived=["Rrrrlr"])
demo.add_population_split(time=497, ancestral="Rrrrr", derived=["H"])
demo.add_population_split(time=622, ancestral="Rrx", derived=["Rrl"])
demo.add_admixture(time=464, derived="admix", ancestral=["Rrrrl","Rrllv"], proportions=[0.57,0.43])
demo.add_admixture(time=360, derived="admixb", ancestral=["admixsc","Rrrrly"], proportions=[0.34,0.66])
demo.add_admixture(time=497, derived="admixe", ancestral=["Rrrlr","Rrrn"], proportions=[0.25,0.75])
demo.add_admixture(time=95, derived="admixm", ancestral=["admixsp","Rrrlr"], proportions=[0.22,0.78])
demo.add_admixture(time=118, derived="admixp", ancestral=["Rrrrlrti","Rrrrlru"], proportions=[0.42,0.58])
demo.add_admixture(time=183, derived="admixr", ancestral=["admixsa","admixsc"], proportions=[0.38,0.62])
demo.add_admixture(time=464, derived="admixs", ancestral=["Rrrrr","Rrx"], proportions=[0.49,0.51])
demo.add_admixture(time=423, derived="admixsa", ancestral=["Rrrlrl","Rrlo"], proportions=[0.8,0.2])
demo.add_admixture(time=118, derived="admixsp", ancestral=["Rrrrlrti","Rrrrlrd"], proportions=[0.56,0.44])
demo.add_admixture(time=95, derived="admixy", ancestral=["admixp","R"], proportions=[0.48,0.52])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_38/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_38/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_38/qpadm_sim_' + sim_id + '.ind', 'w') as f:
