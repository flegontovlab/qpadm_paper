...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("J", "G", "B", "L", "M", "E", "D", "K", "C", "F", "A", "H", "I"), (507, 620, 187, 45, 378, 414, 45, 0, 274, 45, 0, 45, 0) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_31/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_31/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_31/qpadm_sim_' + sim_id + '.ind', 'w') as f:
