...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("I", "D", "L", "M", "B", "F", "E", "C", "G", "A", "K", "J", "H"), (419, 506, 263, 419, 419, 532, 132, 379, 132, 379, 132, 0, 132) )]
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_40/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_40/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_40/qpadm_sim_' + sim_id + '.ind', 'w') as f:
