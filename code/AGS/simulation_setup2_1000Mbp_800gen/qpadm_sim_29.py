...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("M", "E", "K", "I", "J", "D", "A", "G", "B", "C", "F", "H", "L"), (650, 545, 545, 594, 455, 294, 355, 294, 0, 430, 219, 294, 219) )]
...
demo.add_population_split(time=430, ancestral="admix", derived=["A"])
demo.add_population_split(time=294, ancestral="admixc", derived=["L"])
demo.add_population_split(time=455, ancestral="admixe", derived=["C"])
demo.add_population_split(time=90, ancestral="admixg", derived=["B"])
demo.add_population_split(time=430, ancestral="admixr", derived=["Rlrrk"])
demo.add_population_split(time=355, ancestral="admixs", derived=["H"])
demo.add_population_split(time=766, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=716, ancestral="Rl", derived=["M","Rlh"])
demo.add_population_split(time=650, ancestral="Rlh", derived=["Rlr","Rlhr"])
demo.add_population_split(time=594, ancestral="Rlhr", derived=["Rlhrf"])
demo.add_population_split(time=545, ancestral="Rlhrf", derived=["Rlhrfl"])
demo.add_population_split(time=594, ancestral="Rlr", derived=["E","Rlrr"])
demo.add_population_split(time=545, ancestral="Rlrr", derived=["Rlrrm"])
demo.add_population_split(time=355, ancestral="Rlrrk", derived=["G"])
demo.add_population_split(time=716, ancestral="Rr", derived=["Rrl","Rrb"])
demo.add_population_split(time=650, ancestral="Rrb", derived=["Rrr"])
demo.add_population_split(time=650, ancestral="Rrl", derived=["Rrll","I"])
demo.add_population_split(time=594, ancestral="Rrll", derived=["K","Rrllr"])
demo.add_population_split(time=594, ancestral="Rrr", derived=["Rrrl","Rrrr"])
demo.add_population_split(time=545, ancestral="Rrrr", derived=["J","Rrrrg"])
demo.add_population_split(time=455, ancestral="Rrrrg", derived=["Rrrrgh"])
demo.add_population_split(time=430, ancestral="Rrrrgh", derived=["Rrrrr"])
demo.add_population_split(time=355, ancestral="Rrrrr", derived=["D","Rrrrrd"])
demo.add_population_split(time=294, ancestral="Rrrrrd", derived=["F"])
demo.add_admixture(time=430, derived="admix", ancestral=["Rlrrm","Rrrl"], proportions=[0.11,0.89])
demo.add_admixture(time=129, derived="admixb", ancestral=["admixet","Rrrrrd"], proportions=[0.19,0.81])
demo.add_admixture(time=294, derived="admixc", ancestral=["admixo","Rlhrfl"], proportions=[0.49,0.51])
demo.add_admixture(time=455, derived="admixe", ancestral=["Rrllr","Rlhr"], proportions=[0.54,0.46])
demo.add_admixture(time=294, derived="admixet", ancestral=["Rlrrk","Rrrrg"], proportions=[0.49,0.51])
demo.add_admixture(time=90, derived="admixg", ancestral=["admixb","Rlrrm"], proportions=[0.31,0.69])
demo.add_admixture(time=455, derived="admixn", ancestral=["Rrrl","Rrb"], proportions=[0.77,0.23])
demo.add_admixture(time=355, derived="admixo", ancestral=["admixn","Rlhrf"], proportions=[0.18,0.82])
demo.add_admixture(time=430, derived="admixr", ancestral=["Rlhrfl","Rlrr"], proportions=[0.29,0.71])
demo.add_admixture(time=355, derived="admixs", ancestral=["Rrrrgh","Rrllr"], proportions=[0.7,0.3])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/10chr/sim_29/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/10chr/sim_29/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/10chr/sim_29/qpadm_sim_' + sim_id + '.ind', 'w') as f:
