...
basedir = "./projects/qpadm/results/simout/30chr_deep_subsampled"
outdir = "./projects/qpadm/results/qpadm/30chr_deep_subsampled"
...
if (sim == "sim_9"){
  allpops = LETTERS[1:14]
} else{
  allpops = LETTERS[1:13]
}
