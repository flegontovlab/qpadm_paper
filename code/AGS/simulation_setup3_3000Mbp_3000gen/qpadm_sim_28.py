...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("I", "D", "H", "M", "F", "L", "E", "A", "C", "J", "G", "B", "K"), (870, 1718, 1594, 705, 1309, 1470, 1470, 0, 1594, 611, 870, 1309, 705) )]
...
demo.add_population_split(time=2572, ancestral="R", derived=["Rv","Rp"])
demo.add_population_split(time=2115, ancestral="Rl", derived=["Rlr","Rlh"])
demo.add_population_split(time=2014, ancestral="Rlr", derived=["Rlrr","Rlrw"])
demo.add_population_split(time=1470, ancestral="Rlrl", derived=["Rlrlr"])
demo.add_population_split(time=1309, ancestral="Rlrlr", derived=["I"])
demo.add_population_split(time=1912, ancestral="Rlrr", derived=["D"])
demo.add_population_split(time=1912, ancestral="Rlrw", derived=["Rlrm"])
demo.add_population_split(time=2434, ancestral="Rp", derived=["Rl"])
demo.add_population_split(time=1912, ancestral="Rr", derived=["Rrl","Rrr"])
demo.add_population_split(time=1718, ancestral="Rrl", derived=["H"])
demo.add_population_split(time=1470, ancestral="Rrlr", derived=["F","Rrlrn"])
demo.add_population_split(time=870, ancestral="Rrlrl", derived=["M"])
demo.add_population_split(time=1309, ancestral="Rrlrn", derived=["Rrlrl"])
demo.add_population_split(time=1718, ancestral="Rrr", derived=["Rrrr","Rrrf"])
demo.add_population_split(time=1594, ancestral="Rrrf", derived=["E"])
demo.add_population_split(time=1594, ancestral="Rrrr", derived=["L","Rrrrs"])
demo.add_population_split(time=1470, ancestral="Rrrrs", derived=["B"])
demo.add_population_split(time=2434, ancestral="Rv", derived=["Rvh"])
demo.add_population_split(time=2115, ancestral="Rvh", derived=["Ry"])
demo.add_population_split(time=2014, ancestral="Ry", derived=["Rr"])
demo.add_population_split(time=1594, ancestral="admix", derived=["Rlrl"])
demo.add_population_split(time=1594, ancestral="admixd", derived=["Rrlr"])
demo.add_population_split(time=705, ancestral="admixi", derived=["J"])
demo.add_population_split(time=870, ancestral="admixih", derived=["K"])
demo.add_population_split(time=1309, ancestral="admixu", derived=["G"])
demo.add_population_split(time=274, ancestral="admixx", derived=["A"])
demo.add_population_split(time=1718, ancestral="admixz", derived=["C"])
demo.add_admixture(time=1594, derived="admix", ancestral=["Rlrm","Ry"], proportions=[0.18,0.82])
demo.add_admixture(time=1594, derived="admixd", ancestral=["Rrl","Rlrw"], proportions=[0.79,0.21])
demo.add_admixture(time=870, derived="admixdj", ancestral=["Rlrlr","Rvh"], proportions=[0.18,0.82])
demo.add_admixture(time=705, derived="admixi", ancestral=["Rrlrl","Rp"], proportions=[0.68,0.32])
demo.add_admixture(time=870, derived="admixih", ancestral=["Rrlrn","admixo"], proportions=[0.87,0.13])
demo.add_admixture(time=1912, derived="admixo", ancestral=["Rlh","Rv"], proportions=[0.46,0.54])
demo.add_admixture(time=1309, derived="admixu", ancestral=["Rlrl","Rlrm"], proportions=[0.34,0.66])
demo.add_admixture(time=1309, derived="admixv", ancestral=["Rrrrs","Rrrf"], proportions=[0.89,0.11])
demo.add_admixture(time=274, derived="admixx", ancestral=["admixdj","admixv"], proportions=[0.19,0.81])
demo.add_admixture(time=1718, derived="admixz", ancestral=["Rlrr","Rlh"], proportions=[0.63,0.37])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_28/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_28/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_28/qpadm_sim_' + sim_id + '.ind', 'w') as f:
