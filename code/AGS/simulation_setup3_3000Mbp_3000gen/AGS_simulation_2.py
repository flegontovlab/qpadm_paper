...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("I", "B", "M", "K", "A", "F", "H", "J", "L", "E", "C", "D", "G"), (1808, 488, 0, 0, 105, 105, 488, 105, 0, 1219, 488, 0, 488) )]
...
demo.add_population_split(time=2505, ancestral="R", derived=["Rr","Rm"])
demo.add_population_split(time=1894, ancestral="Rl", derived=["I","Rlb"])
demo.add_population_split(time=1808, ancestral="Rlb", derived=["Rlz"])
demo.add_population_split(time=1372, ancestral="Rlz", derived=["E","Rlzn"])
demo.add_population_split(time=2235, ancestral="Rm", derived=["Rl","Rmk"])
demo.add_population_split(time=2235, ancestral="Rr", derived=["Rrl"])
demo.add_population_split(time=1894, ancestral="Rrl", derived=["Rrlj","Rrlw"])
demo.add_population_split(time=1808, ancestral="Rrlj", derived=["Rrlr"])
demo.add_population_split(time=1219, ancestral="Rrll", derived=["Rrlll","Rrllr"])
demo.add_population_split(time=821, ancestral="Rrlll", derived=["B"])
demo.add_population_split(time=821, ancestral="Rrllr", derived=["Rrllrr"])
demo.add_population_split(time=105, ancestral="Rrllrl", derived=["M","K"])
demo.add_population_split(time=488, ancestral="Rrllrr", derived=["A","F"])
demo.add_population_split(time=1372, ancestral="Rrlp", derived=["Rrll"])
demo.add_population_split(time=1372, ancestral="Rrlr", derived=["Rrlrl","Rrlrz"])
demo.add_population_split(time=821, ancestral="Rrlrr", derived=["H"])
demo.add_population_split(time=1219, ancestral="Rrlrz", derived=["Rrlrr"])
demo.add_population_split(time=1808, ancestral="Rrlw", derived=["Rrlp"])
demo.add_population_split(time=488, ancestral="admix", derived=["J"])
demo.add_population_split(time=488, ancestral="admixa", derived=["Rrllrl"])
demo.add_population_split(time=821, ancestral="admixd", derived=["G"])
demo.add_population_split(time=105, ancestral="admixj", derived=["L"])
demo.add_population_split(time=821, ancestral="admixv", derived=["C"])
demo.add_population_split(time=105, ancestral="admixzt", derived=["D"])
demo.add_population_split(time=1808, ancestral="admixzy", derived=["Rrm"])
demo.add_admixture(time=488, derived="admix", ancestral=["Rrlll","admixjy"], proportions=[0.86,0.14])
demo.add_admixture(time=488, derived="admixa", ancestral=["Rrllr","Rmk"], proportions=[0.61,0.39])
demo.add_admixture(time=821, derived="admixd", ancestral=["Rrlrz","Rrm"], proportions=[0.43,0.57])
demo.add_admixture(time=105, derived="admixj", ancestral=["admixx","Rrlp"], proportions=[0.42,0.58])
demo.add_admixture(time=1372, derived="admixjy", ancestral=["Rrlj","Rrlw"], proportions=[0.37,0.63])
demo.add_admixture(time=821, derived="admixv", ancestral=["Rrlrl","Rlzn"], proportions=[0.89,0.11])
demo.add_admixture(time=488, derived="admixx", ancestral=["Rrlrr","Rlzn"], proportions=[0.55,0.45])
demo.add_admixture(time=488, derived="admixz", ancestral=["Rrlrl","Rrm"], proportions=[0.15,0.85])
demo.add_admixture(time=105, derived="admixzt", ancestral=["admixz","Rlb"], proportions=[0.13,0.87])
demo.add_admixture(time=1808, derived="admixzy", ancestral=["Rmk","Rr"], proportions=[0.49,0.51])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_2/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_2/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_2/qpadm_sim_' + sim_id + '.ind', 'w') as f:
