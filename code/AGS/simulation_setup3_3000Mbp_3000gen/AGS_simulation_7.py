...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("B", "E", "I", "L", "G", "D", "J", "M", "K", "C", "F", "A", "H"), (2685, 1365, 1365, 1365, 0, 0, 2104, 2685, 821, 821, 1661, 1751, 964) )]
...
demo.add_population_split(time=2846, ancestral="Rl", derived=["Rll","B"])
demo.add_population_split(time=2846, ancestral="Rr", derived=["Rrl","M"])
demo.add_population_split(time=2685, ancestral="Rrl", derived=["Rrlr","Rrls"])
demo.add_population_split(time=1909, ancestral="Rrll", derived=["Rrlll"])
demo.add_population_split(time=1751, ancestral="Rrlll", derived=["Rrllll","Rrlllc"])
demo.add_population_split(time=1661, ancestral="Rrlllc", derived=["Rrlllr"])
demo.add_population_split(time=1661, ancestral="Rrllll", derived=["Rrlllll"])
demo.add_population_split(time=1541, ancestral="Rrlllll", derived=["E","I"])
demo.add_population_split(time=1541, ancestral="Rrlllr", derived=["L","Rrlllri"])
demo.add_population_split(time=214, ancestral="Rrllr", derived=["G","D"])
demo.add_population_split(time=2422, ancestral="Rrlr", derived=["J","Rrlro"])
demo.add_population_split(time=2104, ancestral="Rrlro", derived=["Rrlrt"])
demo.add_population_split(time=2422, ancestral="Rrls", derived=["Rrlsf","Rrlsj"])
demo.add_population_split(time=2104, ancestral="Rrlsf", derived=["Rrlsm"])
demo.add_population_split(time=2104, ancestral="Rrlsj", derived=["Rrll"])
demo.add_population_split(time=1909, ancestral="Rrlsm", derived=["Rrlsu"])
demo.add_population_split(time=1751, ancestral="Rrlsu", derived=["Rrlsug"])
demo.add_population_split(time=1365, ancestral="admixc", derived=["H"])
demo.add_population_split(time=386, ancestral="admixm", derived=["Rrllr"])
demo.add_population_split(time=964, ancestral="admixq", derived=["K"])
demo.add_population_split(time=1909, ancestral="admixw", derived=["A"])
demo.add_population_split(time=964, ancestral="admixy", derived=["C"])
demo.add_population_split(time=1751, ancestral="admixym", derived=["F"])
demo.add_admixture(time=1541, derived="admix", ancestral=["Rrlllc","admixu"], proportions=[0.64,0.36])
demo.add_admixture(time=1365, derived="admixc", ancestral=["admixn","Rrlro"], proportions=[0.46,0.54])
demo.add_admixture(time=386, derived="admixm", ancestral=["admix","admixqr"], proportions=[0.12,0.88])
demo.add_admixture(time=1541, derived="admixn", ancestral=["Rrlsug","Rll"], proportions=[0.65,0.35])
demo.add_admixture(time=964, derived="admixq", ancestral=["Rrlllri","Rrlsu"], proportions=[0.44,0.56])
demo.add_admixture(time=1541, derived="admixqr", ancestral=["Rrlsug","Rrlsj"], proportions=[0.9,0.1])
demo.add_admixture(time=1751, derived="admixu", ancestral=["Rrll","Rrlrt"], proportions=[0.27,0.73])
demo.add_admixture(time=1909, derived="admixw", ancestral=["Rrlsf","Rll"], proportions=[0.64,0.36])
demo.add_admixture(time=964, derived="admixy", ancestral=["Rrlllri","Rrllll"], proportions=[0.53,0.47])
demo.add_admixture(time=1751, derived="admixym", ancestral=["Rrlrt","Rrlsm"], proportions=[0.12,0.88])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_7/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_7/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_7/qpadm_sim_' + sim_id + '.ind', 'w') as f:
