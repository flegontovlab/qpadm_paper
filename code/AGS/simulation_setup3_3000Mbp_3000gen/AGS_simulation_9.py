...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("D", "K", "J", "F", "H", "L", "M", "B", "I", "G", "C", "E", "A", "N"), (1005, 1005, 1005, 1661, 229, 0, 0, 1661, 701, 229, 701, 1170, 1264, 1661) )]
...
demo.add_population_split(time=2291, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=1976, ancestral="Rl", derived=["Rll","Rlr"])
demo.add_population_split(time=1748, ancestral="Rll", derived=["Rllf","Rlli"])
demo.add_population_split(time=1661, ancestral="Rllf", derived=["Rlll"])
demo.add_population_split(time=1459, ancestral="Rllg", derived=["Rllgl"])
demo.add_population_split(time=1661, ancestral="Rlli", derived=["Rllg"])
demo.add_population_split(time=1459, ancestral="Rlll", derived=["Rlllrh"])
demo.add_population_split(time=1170, ancestral="Rllll", derived=["D"])
demo.add_population_split(time=1170, ancestral="Rlllr", derived=["K","J"])
demo.add_population_split(time=1380, ancestral="Rlllrh", derived=["Rlllv"])
demo.add_population_split(time=1264, ancestral="Rlllv", derived=["Rllll","Rlllvh"])
demo.add_population_split(time=1748, ancestral="Rlr", derived=["F","Rlru"])
demo.add_population_split(time=1459, ancestral="Rlrl", derived=["Rlrlh"])
demo.add_population_split(time=1380, ancestral="Rlrlh", derived=["A"])
demo.add_population_split(time=1661, ancestral="Rlru", derived=["Rlrl"])
demo.add_population_split(time=1976, ancestral="Rr", derived=["Rrr","Rr1"])
demo.add_population_split(time=1748, ancestral="Rr1", derived=["N"])
demo.add_population_split(time=559, ancestral="Rrl", derived=["H","Rrlr"])
demo.add_population_split(time=229, ancestral="Rrlr", derived=["L","M"])
demo.add_population_split(time=1748, ancestral="Rrr", derived=["B","Rrri"])
demo.add_population_split(time=1005, ancestral="admix", derived=["I"])
demo.add_population_split(time=559, ancestral="admixc", derived=["G"])
demo.add_population_split(time=1264, ancestral="admixci", derived=["E"])
demo.add_population_split(time=701, ancestral="admixh", derived=["Rrl"])
demo.add_population_split(time=1264, ancestral="admixu", derived=["Rlllr"])
demo.add_population_split(time=1005, ancestral="admixx", derived=["C"])
demo.add_admixture(time=1005, derived="admix", ancestral=["Rlllvh","Rllg"], proportions=[0.55,0.45])
demo.add_admixture(time=559, derived="admixc", ancestral=["Rllll","admixv"], proportions=[0.71,0.29])
demo.add_admixture(time=1264, derived="admixci", ancestral=["Rlllrh","Rrri"], proportions=[0.16,0.84])
demo.add_admixture(time=701, derived="admixh", ancestral=["admixl","Rr1"], proportions=[0.22,0.78])
demo.add_admixture(time=1005, derived="admixl", ancestral=["Rlllvh","Rlru"], proportions=[0.49,0.51])
demo.add_admixture(time=1380, derived="admixq", ancestral=["Rlrl","Rrri"], proportions=[0.23,0.77])
demo.add_admixture(time=1264, derived="admixu", ancestral=["Rlrlh","Rlll"], proportions=[0.53,0.47])
demo.add_admixture(time=1264, derived="admixv", ancestral=["Rllgl","Rllf"], proportions=[0.74,0.26])
demo.add_admixture(time=1005, derived="admixx", ancestral=["admixxf","Rllgl"], proportions=[0.25,0.75])
demo.add_admixture(time=1264, derived="admixxf", ancestral=["admixq","Rlli"], proportions=[0.49,0.51])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_9/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_9/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_9/qpadm_sim_' + sim_id + '.ind', 'w') as f:
