...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("G", "F", "J", "D", "I", "C", "E", "L", "B", "M", "K", "A", "H"), (915, 679, 915, 1785, 915, 2059, 349, 349, 349, 349, 480, 915, 0) )]
...
demo.add_population_split(time=2895, ancestral="R", derived=["Rl","Rr"])
demo.add_population_split(time=2456, ancestral="Rl", derived=["Rlr","Rln"])
demo.add_population_split(time=1354, ancestral="Rll", derived=["Rllr","Rllk"])
demo.add_population_split(time=1118, ancestral="Rllk", derived=["A"])
demo.add_population_split(time=1118, ancestral="Rllr", derived=["G"])
demo.add_population_split(time=2059, ancestral="Rln", derived=["Rlw"])
demo.add_population_split(time=2059, ancestral="Rlr", derived=["Rlrl","D"])
demo.add_population_split(time=1785, ancestral="Rlrl", derived=["Rlrly"])
demo.add_population_split(time=1118, ancestral="Rlrlr", derived=["Rlrlrl","J"])
demo.add_population_split(time=915, ancestral="Rlrlrl", derived=["F","Rlrlrla"])
demo.add_population_split(time=679, ancestral="Rlrlrla", derived=["K"])
demo.add_population_split(time=1354, ancestral="Rlrly", derived=["Rlrlr"])
demo.add_population_split(time=1785, ancestral="Rlw", derived=["Rll","Rlwk"])
demo.add_population_split(time=2456, ancestral="Rr", derived=["C","Rrr"])
demo.add_population_split(time=1354, ancestral="Rrl", derived=["Rrll","Rrlr"])
demo.add_population_split(time=1118, ancestral="Rrll", derived=["I"])
demo.add_population_split(time=1118, ancestral="Rrlr", derived=["Rrlro"])
demo.add_population_split(time=2059, ancestral="Rrr", derived=["Rrrl"])
demo.add_population_split(time=1785, ancestral="Rrrl", derived=["Rrl"])
demo.add_population_split(time=480, ancestral="admix", derived=["E"])
demo.add_population_split(time=915, ancestral="admixd", derived=["Rrlry"])
demo.add_population_split(time=349, ancestral="admixg", derived=["H"])
demo.add_population_split(time=480, ancestral="admixi", derived=["L"])
demo.add_population_split(time=480, ancestral="admixq", derived=["M"])
demo.add_population_split(time=480, ancestral="admixt", derived=["B"])
demo.add_admixture(time=480, derived="admix", ancestral=["admixx","Rlwk"], proportions=[0.11,0.89])
demo.add_admixture(time=915, derived="admixd", ancestral=["Rrlr","Rllk"], proportions=[0.83,0.17])
demo.add_admixture(time=679, derived="admixf", ancestral=["admixnb","Rln"], proportions=[0.43,0.57])
demo.add_admixture(time=349, derived="admixg", ancestral=["admixn","Rlwk"], proportions=[0.25,0.75])
demo.add_admixture(time=480, derived="admixi", ancestral=["admixf","Rrr"], proportions=[0.19,0.81])
demo.add_admixture(time=480, derived="admixn", ancestral=["Rlrlrla","Rlrl"], proportions=[0.69,0.31])
demo.add_admixture(time=915, derived="admixnb", ancestral=["Rllr","Rrrl"], proportions=[0.43,0.57])
demo.add_admixture(time=480, derived="admixq", ancestral=["Rrlry","Rrlro"], proportions=[0.69,0.31])
demo.add_admixture(time=480, derived="admixt", ancestral=["Rrlry","Rlrly"], proportions=[0.72,0.28])
demo.add_admixture(time=679, derived="admixx", ancestral=["Rrlro","Rrll"], proportions=[0.55,0.45])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_39/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_39/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_39/qpadm_sim_' + sim_id + '.ind', 'w') as f:
