...
samples = [msprime.SampleSet(num_samples=i, population=j, time=k) for i, j, k in zip( (10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), ("L", "M", "I", "E", "H", "A", "D", "B", "F", "K", "C", "G", "J"), (1406, 1406, 1586, 1586, 2422, 2025, 1406, 1586, 1586, 0, 1586, 739, 739) )]
...
demo.add_population_split(time=2966, ancestral="R", derived=["Rr","Rp"])
demo.add_population_split(time=2561, ancestral="Rl", derived=["Rllw","Rlc"])
demo.add_population_split(time=2422, ancestral="Rlc", derived=["Rlr"])
demo.add_population_split(time=2220, ancestral="Rll", derived=["Rllj","Rlle"])
demo.add_population_split(time=2025, ancestral="Rlle", derived=["Rlll"])
demo.add_population_split(time=2025, ancestral="Rllj", derived=["C"])
demo.add_population_split(time=1586, ancestral="Rlll", derived=["L","M"])
demo.add_population_split(time=2422, ancestral="Rllw", derived=["Rll"])
demo.add_population_split(time=2220, ancestral="Rlr", derived=["Rlrl"])
demo.add_population_split(time=2025, ancestral="Rlrl", derived=["I","E"])
demo.add_population_split(time=2816, ancestral="Rp", derived=["Rl"])
demo.add_population_split(time=2816, ancestral="Rr", derived=["Rrl","Rrc"])
demo.add_population_split(time=2561, ancestral="Rrc", derived=["Rrr"])
demo.add_population_split(time=2561, ancestral="Rrl", derived=["H"])
demo.add_population_split(time=2422, ancestral="Rrr", derived=["Rrrl","Rrrx"])
demo.add_population_split(time=2220, ancestral="Rrrl", derived=["A","Rrrlz"])
demo.add_population_split(time=1586, ancestral="Rrrlr", derived=["D","Rrrlrg"])
demo.add_population_split(time=2025, ancestral="Rrrlz", derived=["Rrrlr","Rrrlzk"])
demo.add_population_split(time=2025, ancestral="Rrrr", derived=["B","F"])
demo.add_population_split(time=2220, ancestral="Rrrx", derived=["Rrrr"])
demo.add_population_split(time=409, ancestral="admix", derived=["K"])
demo.add_population_split(time=904, ancestral="admixc", derived=["J"])
demo.add_population_split(time=904, ancestral="admixk", derived=["G"])
demo.add_admixture(time=409, derived="admix", ancestral=["admixx","Rrrlzk"], proportions=[0.42,0.58])
demo.add_admixture(time=904, derived="admixc", ancestral=["admixj","Rrc"], proportions=[0.28,0.72])
demo.add_admixture(time=1268, derived="admixj", ancestral=["Rrrlrg","Rp"], proportions=[0.82,0.18])
demo.add_admixture(time=904, derived="admixk", ancestral=["admixn","Rlle"], proportions=[0.44,0.56])
demo.add_admixture(time=2025, derived="admixkd", ancestral=["Rrrx","Rllw"], proportions=[0.88,0.12])
demo.add_admixture(time=1406, derived="admixn", ancestral=["admixw","Rlc"], proportions=[0.42,0.58])
demo.add_admixture(time=904, derived="admixo", ancestral=["admixq","Rrrlzk"], proportions=[0.21,0.79])
demo.add_admixture(time=1268, derived="admixq", ancestral=["Rrrlrg","Rllj"], proportions=[0.76,0.24])
demo.add_admixture(time=1586, derived="admixw", ancestral=["admixkd","Rrl"], proportions=[0.3,0.7])
demo.add_admixture(time=739, derived="admixx", ancestral=["admixo","Rlr"], proportions=[0.17,0.83])
demo.sort_events()
...
numpy.savetxt('./projects/qpadm/results/simout/30chr_deep/sim_34/qpadm_sim_' + sim_id + '.geno', gt, '%d', '')

with open('./projects/qpadm/results/simout/30chr_deep/sim_34/qpadm_sim_' + sim_id + '.snp', 'w') as f:
...
with open('./projects/qpadm/results/simout/30chr_deep/sim_34/qpadm_sim_' + sim_id + '.ind', 'w') as f:
